<?php
    /* ================================================
    File Name         	  : instituteWiseDetails.php
    ...
    Style sheet           : 
    Javscript Functions   : 
    includes		  : util.php, instituteWiseDetails.php

    ==================================================*/
    require 'instituteWiseDetailsInner.php';
    ...
    <div class="page-content">
        ...
        <div class="row">
            ...
            <div class="top_tab_container">
                <a href="javascript:void(0);" class="btn btn-info active">Institute Wise Report <span class="badge badge-pill badge-danger"><strong><?php echo $toalNumber;?></strong></span></a>
            </div>
                            ...
                            <tr>
                               ...
                               <td><?php echo $ctr; ?></td>
                                ...
                                <?php if ($row['totalCandidate'] > 0) { ?>
                                            <a href="<?php echo APP_URL; ?>viewInstituteCandidateDetails/<?php echo $glId; ?>/<?php echo $plId; ?>/<?php echo $row['intId']; ?>" class="badge badge-primary" ><?php echo $row['totalCandidate']; ?></a>
                                        <?php } else {
