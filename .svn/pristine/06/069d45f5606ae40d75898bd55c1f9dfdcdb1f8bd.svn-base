<?php
	...
	Javscript Functions       : jquery.js, loadComponent.js,loadAjax.js,validator.js
...
<script language="javascript"> 
	...
	{ 
            ...
            if(count_checked>0)
            {  
                    $('#chkBox_'+gl+'_'+pl).prop('checked',true);
                    $('#hdn_'+gl+'_'+pl).val(1);		
            }
            else
            {
                    $('#chkBox_'+gl+'_'+pl).prop('checked',false);
                    $('#hdn_'+gl+'_'+pl).val(0);		
            }
        ...
        <div class="row">
            <div class="col-xs-12">
                 ...
                 <div class="top_tab_container">
                     <a href="javascript:void(0);" class="btn btn-info active">Set Permission</a> </div>
                 <?php include('includes/util.php'); ?>
                <div class="hr hr-solid"></div>
                <div class="searchTable">
                    <div class="form-group">
                        <label class="col-sm-2 control-label no-padding-right" for="txtHeadlineE">User Name </label>
                        <div class="col-sm-4">
                            <span class="colon">:</span>
                           <select name="DdlName" id="DdlName" class="form-control" onChange="fillPermission(this.value);">
