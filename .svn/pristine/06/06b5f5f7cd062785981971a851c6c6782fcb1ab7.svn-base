<?php
    ...
    ==================================================*/
    require 'viewITIReportInner.php';
?>
<script src="<?php echo APP_URL; ?>js/validatorchklist.js"></script>
<script language="javascript">
	$(document).ready(function () {
            loadNavigation('ITI Report');
            pageHeader      = "ITI Report";
            strFirstLink    = "Manage Reports";
            strLastLink     = "ITI Report";
            downloadMe    = "yes";
    ...
    <div class="page-content">
        ...
        <div class="row">
            ...
            <div class="top_tab_container">
                <a href="javascript:void(0);" class="btn btn-info active">ITIs <span class="badge badge-pill badge-danger"><strong><?php echo $itiCount;?></strong></span></a>
              ...
              <div class="form-group">
                        ...
                        <div class="col-sm-2"> 
                            ...
                            <select class="form-control" name="selType" id="selType" >
                                <option  <?php if( $strType=='1,2') echo 'selected="selected"';?> value="0">--All--</option>
                                <option  <?php if( $strType=='1') echo 'selected="selected"';?> value="1">Govt.</option>
                                <option  <?php  if( $strType=='2') echo 'selected="selected"';?> value="2">Private</option>
                            </select>
