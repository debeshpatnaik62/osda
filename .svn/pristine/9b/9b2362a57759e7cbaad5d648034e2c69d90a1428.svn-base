<?php
    /* ================================================
    File Name         	  : viewOtherReport.php
    Description		      : This is used for view IT Report.
    ...
    Style sheet           : 
    Javscript Functions   : 
    includes		  : util.php, viewOtherReport.php

    ==================================================*/
    require 'viewOtherReportInner.php';
?>
<script src="<?php echo APP_URL; ?>js/validatorchklist.js"></script>
<script language="javascript">
	$(document).ready(function () {
            loadNavigation('Other Institute Report');
            pageHeader      = "Other Institute Report";
            strFirstLink    = "Manage Reports";
            strLastLink     = "Other Institute Report";
            downloadMe    = "yes";
    ...
    <div class="page-content">
        ...
        <div class="row">
            ...
            <div class="top_tab_container">
                ...
                <a href="<?php echo APP_URL;?>viewITIReport/<?php echo $glId; ?>/<?php echo $plId; ?>" class="btn btn-info">ITIs<span class="badge badge-light"><?php echo $itiCount;?></span></a>
                ...
                <a href="javascript:void(0);" class="btn btn-info active">Others <span class="badge badge-pill badge-danger"><strong><?php echo $toalNumber;?></strong></span></a>
            </div>
 ...
 -->
                      ...
                      <div class="col-sm-2">
                        ...
                        <input class="btn btn-danger" name="btnClear" type="button" value="Clear" onclick="window.location.href ='<?php echo APP_URL; ?>viewOtherReport/<?php echo $glId . '/' . $plId; ?>' ">
                     </div>                
              </div>
            </div>            
                <div id="viewTable">
              		...
              		<tbody>
                        <?php while ($row = mysqli_fetch_array($result)) {
                            ...
                            <tr>
                               ...
                               <td><?php echo $ctr; ?></td>
                                <td> <?php  echo htmlspecialchars_decode($row['vchWorkPlace'],ENT_QUOTES);?> </td>
                                <td> <?php  echo $row['totalOther'];?> </td>  
                            </tr>
                        <?php } ?>
                         </tbody>
                    </table>
