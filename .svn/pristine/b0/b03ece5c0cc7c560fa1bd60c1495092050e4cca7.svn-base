...
<html lang="en">
    ...
    <style type="text/css">
        ...
        .dist-block.active{fill:#c579ca !important;}
        .dist-block.active{background:#c579ca !important;}
		@media all and (-ms-high-contrast: none), (-ms-high-contrast: active) {.mapBox{height:700px !important;padding-bottom:50px;}}
    </style>
    <!--start:: contarea-->
    ...
    <section class="container contarea">
        <ul class="nav nav-pills mb-3" id="pills-tab" role="tablist">
            <li class="nav-item">
                <a class="nav-link active screenreader <?php echo $strLangCls; ?>" id="pills-all-tab" data-toggle="pill" href="#pills-all" role="tab" aria-controls="pills-all" aria-selected="true"><?php echo $strListviewlbl; ?></a>
            </li>
            <li class="nav-item">
                <a class="nav-link screenreader <?php echo $strLangCls; ?>" id="pills-Short-tab" data-toggle="pill" href="#pills-Short" role="tab" aria-controls="pills-Short" aria-selected="false"><?php echo $strMapviewlbl; ?></a>
            </li>
        </ul>
                ...
                <div class="row">
                    <div class="col-sm-4">
                        <div class="leftsec">
                            <div class="togglesec">
                                <div>
                                    <a class="tabheader screenreader <?php echo $odiaClass;?>" data-toggle="collapse" href="#distList" role="button" aria-expanded="false" aria-controls="longterm"><?php echo $filterDistLevel;?> <i class="fa fa-angle-down" aria-hidden="true"></i></a>
                                </div>
                                <div class="collapse show" id="distList">
                                </div>
                            </div>
                        </div>
                    </div>
...
<!--                            <div class="coursesportlet noborder">
            ...
            <div class="tab-pane fade" id="pills-Short" role="tabpanel" aria-labelledby="pills-Short-tab">
                <div class="row">
                    <div class="col-sm-8">
                        <h2 class="text-center screenreader <?php echo $strLangCls; ?>"><?php echo $strOdishamaplbl; ?>
                            <span class="inspagelabelno screenreader"><?php echo $strInstCountinfo1; ?> <span class="<?php echo $strNumLangCls; ?>"><?php echo $intTotalRec; ?></span><?php echo $strInstCountinfoPol; ?></span>
                        </h2>
                        <div class="mapBox">
                            <svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
                                 viewBox="0 0 605 476" style="enable-background:new 0 0 605 476;" xml:space="preserve">
                            <?php
                            /* $counterArray = array(); 
                              if ($mapcount > 0) {
                            ...
                            if ($mapcount > 0) {
                                ...
                                while ($distrow = $mapresult->fetch_array()) {
                                    ...
                                    if ($distrow['instituteCount'] > 0) {
                                        ...
                                        <text transform="<?php echo $distrow['vchSvgTransform']; ?>" data-distid="<?php echo $distrow['intDistrictid']; ?>" class="vals <?php echo $strNumLangCls; ?>" text-anchor="middle"
                                              x="5" y="1"><?php echo $distrow['instituteCount']; ?></text>
                                              <?php
                                          }
                                      }
                                  }
                    ...
                    <div class="col-sm-4">
                        ...
                        <div class="panel-group distaccordian" id="accordion" >
                        </div>
                    </div>
                </div>
            </div>
...
<?php } ?>
        ...
        $('h4.panel-title').each(function () {
            ...
            if ($(this).parents().next('.panel-collapse').hasClass('in') == true) {
        ...
        $('h4.panel-title').click(function () {
            $(".panel-group .panel-collapse").find(".show").removeClass(".show");
            $(".panel-group a").attr('aria-expanded',false);
           $(this).closest("a").removeClass('collapsed');
           $(this).closest("a").attr('aria-expanded',true);
            ...
            // if ($(this).parents().next('.panel-collapse').hasClass('') == true) {
            //     //alert('yes');
