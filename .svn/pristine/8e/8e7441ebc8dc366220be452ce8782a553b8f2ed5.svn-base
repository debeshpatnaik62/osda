<?php
    /* ================================================
    File Name         	: archiveEmpDirectoryInner.php
       ...
       //============ Search Function ========================//
        ...
        try{
         //============= Delete/Active/Inactive function =================
            ...
            if($isPaging==0)	
                $result                 = $objEmpDirectory->manageEmpDirectory('PG',$intRecno,0,$intDistid,$strEmployeeName,'','','','','',0,1,0,$intPgSize);
            else                                    
            {
                $intPgno                = 1;
                $intRecno               = 0;
                $result                 = $objEmpDirectory->manageEmpDirectory('V',0,0,$intDistid,$strEmployeeName,'','','','','',0,1,0,$intPgSize);
            }
            $totalResult                = $objEmpDirectory->manageEmpDirectory('CT',0,0,$intDistid,$strEmployeeName,'','','','','',0,1,0,$intPgSize);
