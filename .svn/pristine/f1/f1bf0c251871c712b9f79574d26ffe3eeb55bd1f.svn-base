...
<html lang="en">
    ...
    <style type="text/css">
        ...
        .dist-block.active{fill:#85398a !important;}
        .dist-block.active{background:#85398a !important;}
    ...
    <section class="container contarea">
        <ul class="nav nav-pills" id="pills-tab" role="tablist">
            <li class="nav-item">
                <a class="nav-link active <?php echo $strLangCls; ?>" id="pills-all-tab" data-toggle="pill" href="#pills-all" role="tab" aria-controls="pills-all" aria-selected="true"><?php echo $strListviewlbl; ?></a>
            </li>
            <li class="nav-item">
                <a class="nav-link <?php echo $strLangCls; ?>" id="pills-Short-tab" data-toggle="pill" href="#pills-Short" role="tab" aria-controls="pills-Short" aria-selected="false"><?php echo $strMapviewlbl; ?></a>
            </li>
        </ul>
                ...
                <div class="row">
                    <div class="col-sm-4">
                        <div class="leftsec">
                            <div class="togglesec">
                                <div>
                                    <a class="tabheader" data-toggle="collapse" href="#distList" role="button" aria-expanded="false" aria-controls="longterm"><?php echo $filterDistLevel;?><i class="fa fa-angle-down" aria-hidden="true"></i></a>
                                </div>
                ...
                <div class="row">
                    <div class="col-sm-8">
                        <h2 class="text-center screenreader <?php echo $strLangCls; ?>"><?php echo $strOdishamaplbl; ?>
                            <span class="inspagelabelno screenreader"><?php echo $strInstCountinfo1; ?> <span class="<?php echo $strNumLangCls; ?>"><?php echo $intTotalRec; ?></span><?php echo $strInstCountinfo5; ?></span>
                        </h2>
                        <div class="mapBox">
