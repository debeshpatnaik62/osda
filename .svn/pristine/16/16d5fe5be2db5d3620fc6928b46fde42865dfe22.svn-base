<?php
    ...
    includes		  : header.php, navigation.php, util.php, footer.php,archieveGalleryInner.php
...
<script language="javascript">
	$(document).ready(function () {
		loadNavigation('Archive Media Gallery');
                        ...
                        while ($row = mysqli_fetch_array($result)) {
                            ...
                            <tr <?php //echo $style;?>>
                                ...
                                <td> <?php if($row['VCH_DESCRIPTION_E']!=''){?>
                                    ...
                                    <?php }else{  echo htmlspecialchars_decode($row['VCH_HEADLINE_E'],ENT_NOQUOTES);}?>
                                </td>  
                                <td class="odia"> <?php if($row['VCH_HEADLINE_O']!=''){?>
                                    <a href="javascript:void(0);" title="Gallery Details" class="showModal" onclick="getGalleryDetails('<?php echo $row['INT_GALLERY_ID'];?>',2)"><?php echo htmlspecialchars_decode($row['VCH_HEADLINE_O'],ENT_NOQUOTES);?></a>
                                    <?php }else{  echo htmlspecialchars_decode($row['VCH_HEADLINE_O'],ENT_NOQUOTES);}?>
                                </td>  
                                <td><?php
