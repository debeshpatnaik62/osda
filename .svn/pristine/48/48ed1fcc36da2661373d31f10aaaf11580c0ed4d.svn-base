<?php
	...
	if(isset($_REQUEST['hdn_qs'])&& $_REQUEST['hdn_qs']!='' )
	{
        ...
        if($isPaging==0)	
        $result		= $objTender->manageTender('PG',$intRecno,0,'',$strTenderTitle,'','','',BLANK_DATE,BLANK_DATE,'','',0,0,0,0,BLANK_DATE,BLANK_DATE,BLANK_DATE,'','',0,0,'','');
	else
	{
        $intPgno	= 1;
        $intRecno	= 0;
        $result     = $objTender->manageTender('V',0,0,'',$strTenderTitle,'','','',BLANK_DATE,BLANK_DATE,'','',0,0,0,0,BLANK_DATE,BLANK_DATE,BLANK_DATE,'','',0,0,'','');
	}
       $totalResult     = $objTender->manageTender('V',0,0,'',$strTenderTitle,'','','',BLANK_DATE,BLANK_DATE,'','',0,0,0,0,BLANK_DATE,BLANK_DATE,BLANK_DATE,'','',0,0,'','');
