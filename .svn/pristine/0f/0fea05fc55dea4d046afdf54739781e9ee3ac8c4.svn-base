       ...
       //============ Search Function ========================//
        ...
        try{
         //============= Delete/Active/Inactive function =================
            ...
            if($isPaging==0)	
                $result                 = $objVenue->manageVenue('PG',$intRecno,$intDistid,$strEmployeeName,'','','','',0,'','',0,0,0,$intPgSize);
            else                                    
            {
                $intPgno                = 1;
                $intRecno               = 0;
                $result                 = $objVenue->manageVenue('V',0,$intDistid,$strEmployeeName,'','','','',0,'','',0,0,0,$intPgSize);
            }
            $totalResult                = $objVenue->manageVenue('CT',0,$intDistid,$strEmployeeName,'','','','',0,'','',0,0,0,$intPgSize);
