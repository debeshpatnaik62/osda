       ...
       //============ Search Function ========================//
        ...
        try{
         //============= Delete/Active/Inactive function =================
            ...
            if($isPaging==0)	
                $result                 = $objVenueTag->manageVenueTagged('PG',$intRecno,'',0,$intSkill,$intDistid,$venueId,'1000-01-01','00:00:00',$regdType,'','',$intPgSize);
            else                                    
            {
                $intPgno                = 1;
                $intRecno               = 0;
                $result                 = $objVenueTag->manageVenueTagged('V',0,'',0,$intSkill,$intDistid,$venueId,'1000-01-01','00:00:00',$regdType,'','',$intPgSize);
            }
            $totalResult                = $objVenueTag->manageVenueTagged('CT',0,'',0,$intSkill,$intDistid,$venueId,'1000-01-01','00:00:00',$regdType,'','',$intPgSize);
