<?php
    ...
    require 'viewTPRegistrationRequestInner.php';
?>
...
<script language="javascript">
	$(document).ready(function () {
		pageHeader = "Digital Skilling";
                ...
                strLastLink = "TP Registration Request";
               loadNavigation('Digital Skilling Report');
        ...
        $('.dispProfilemodal').on('click',function(){
              ...
              $("#dispProfile").load('<?php echo APP_URL;?>tpDetails/'+tpId);
        });
            
	});
        
   function programStatusData(intId,userId)
    { 
    ...
    <div class="page-content">
        ...
        <div class="row no-margin">
            ...
            <div class="top_tab_container">
                ...
                <a href="javascript:void(0);" class="btn btn-info active">View TP Registration Request</a>
                ...
                <div class="searchTable">
                    ...
                    <label class="col-sm-1 control-label no-padding-right" for="txtSearch">Partner Name</label>
                    <div class="col-sm-2"> <span class="colon">:</span> 
                        <input type="text" class="form-control" maxlength="200" name="vchOrgName" id="vchOrgName" value="<?php echo $vchOrgName; ?>"/>
                    </div>
                    ...
                    <div class="col-sm-2"> <span class="colon">:</span> 
                        ...
                        <input class="btn btn-danger" name="btnClear" type="button" value="Clear" onclick="window.location.href ='<?php echo APP_URL; ?>viewTPRegistrationRequest/<?php echo $glId . '/' . $plId; ?>' ">
                    </div>
                  </div>
                </div>
                </div>
                    ...
                    <table class="table  table-bordered table-hover">
                        <thead>
                            <tr>
                                ...
                                <th width="20">Sl.#</th>
                                <th>Training Partner Details</th>    
                                <th>Partner Regd No.</th>
                            ...
                            <tr>
                                ...
                                <td>
                                  <div class="media-body pull-left"> 
                                        ...
                                        <h4><?php echo htmlspecialchars_decode($row['vchOrgName'], ENT_QUOTES); ?></h4>
                                        <small class="text-primary"><i class="fa fa-phone"></i> +91- <?php echo $row['vchOrgMobile']; ?></small><br/>    
                                        <small class="text-muted"><i class="fa fa-envelope"></i> <?php echo htmlspecialchars_decode($row['vchOrgEmail'],ENT_QUOTES); ?></small> 
                                      </div>
                                ...
                                <td>
                                  <a data-toggle="modal" style="cursor:pointer;" data-target="#modalProfile" data-applicant="<?php echo $objTP->encrypt($row['intId']); ?>" class="dispProfilemodal btn btn-xs btn-info"><i class="ace-icon fa fa-file-text bigger-120"></i></a>
                                </td>
                                <td> 
                                  ...
                                  <div style="display: flex;"> 
                                    <input type="button" name="btnUpdate" id="btnUpdate" class="btn btn-success noPrint" value="Approve" style="margin-left:5px;" onclick="programStatusData('<?php echo $row['intId'];?>','<?php echo $row['vchUserId'];?>')" >
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title noPrint" id="myModalLabel">Training Partner Registration Request</h4>
            </div>
    ...
    <div class="modal-content animated bounceInUp">
        <div class="modal-header" >
             ...
             <a href="javascript:void(0)" title="Print" onclick="printModal('myModalLabel','dispProfile');" class="btn btn-success btn-sm pull-right" style="margin-right:10px;"><i class="icon-white icon-print"></i> Print</a>
                <h4 class="modal-title" id="myModalLabel">Training Partner Details</h4>
