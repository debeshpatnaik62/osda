<?php
    ...
    ==================================================*/
    require 'viewHMReportInner.php';
?>
<script src="<?php echo APP_URL; ?>js/validatorchklist.js"></script>
<script language="javascript">
	$(document).ready(function () {
            loadNavigation('Hotel Management College Report');
            pageHeader      = "Hotel Management College Report";
            strFirstLink    = "Manage Reports";
            strLastLink     = "Hotel Management College Report";
            downloadMe      ='yes';
    ...
    <div class="page-content">
        ...
        <div class="row">
            ...
            <div class="top_tab_container">
                ...
                <a href="javascript:void(0);" class="btn btn-info active">Hotel Management <span class="badge badge-danger"><?php echo  $hmCount;?></span></a>
 ...
 -->
                      ...
                      <div class="col-sm-2">
                        ...
                        <input class="btn btn-danger" name="btnClear" type="button" value="Clear" onclick="window.location.href ='<?php echo APP_URL; ?>viewHMReport/<?php echo $glId . '/' . $plId; ?>' ">
                     </div>                
              </div>
            </div>
                <div id="viewTable">
                <?php if (mysqli_num_rows($result) > 0) {
                    ...
                    <input name="hdn_qualification" id="hdn_qualify" type="hidden" value="23"/>
                <?php } else { ?>
