...
<script language="javascript">
	$(document).ready(function () {
		pageHeader = "View Infocus";
                strFirstLink = "Manage Application";
                strLastLink = "Infocus";
               loadNavigation('View Infocus');
    ...
    <div class="page-content">
        ...
        <div class="row">
            ...
            <div class="top_tab_container">
               <?php  if ($noAdd != '1') { ?>
                    <a href="<?php echo APP_URL?>addInfocus/<?php echo $glId; ?>/<?php echo $plId; ?>" class="btn btn-info">Add</a>
                <?php }?>
                ...
                <div class="searchTable">
                    <div class="form-group">
                        ...
                        <div class="col-sm-2">
                            ...
                            <input class="btn btn-danger" name="btnClear" type="button" value="Clear" onclick="window.location.href ='<?php echo APP_URL; ?>viewInfocus/<?php echo $glId . '/' . $plId; ?>' ">
                        </div>
                    </div>
                </div>
                <div class="legandBox">			
                    <span class="greenLegend">&nbsp;</span>Published Infocus(s)&nbsp;			
                    <span class="yellowLegend">&nbsp;</span> Unpublished Infocus(s) &nbsp;
                </div>
                <div id="viewTable">
              		...
              		<tbody>
                        <?php while ($row = mysqli_fetch_array($result)) {
                            ...
                            <tr <?php echo $style;?>>
                                    ...
                                    <?php if($row['vchImage']!='')
                                     {
                                         ...
                                         {
                                    ?>
                                            <a href="<?php echo APP_URL ?>uploadDocuments/Infocus/<?php echo $row['vchImage'];?>" target="_blank" Name="Infocus Photo"><img src="<?php echo APP_URL ?>uploadDocuments/Infocus/<?php echo $row['vchImage'];?>" alt="<?php echo $row['vchName']; ?>" width="150" height="80" /></a>
                                    <?php 
                                         }
                                        else {
                                       ?>
                                           <a href="<?php echo APP_URL;?>uploadDocuments/Infocus/<?php echo $row['vchImage'];?>" target="_blank"><?php if($vchImage=='pdf'){?><img src="<?php echo APP_URL;?>img.png" alt="" width="16" height="16" border="0" align="absmiddle"><?php } else{?><img src="<?php echo APP_URL;?>img/wordIcon.jpg" alt="" width="20" height="20" border="0" align="absmiddle"><?php }?></a>
                              ...
                              <!--   <td width="100"><?php
                                    if(strtotime($row['dtmDate'])>0)
                                    echo date("d-M-Y",strtotime($row['dtmDate']));
                                    else echo '&nbsp;';?>
                                </td> -->
                                 ...
                                 <td> 
                                    ...
                                    <?php if ($row['vchDescription'] != '') { ?>
                                            ...
                                            <?php $strMessage =  htmlspecialchars_decode($row['vchDescription'], ENT_QUOTES); 
                                              echo $shortmsg = $objInfocus->wardWrap($strMessage, 100);
                                            ?></a>
                                  ...
                                  <td> 
                                    ...
                                    <?php if ($row['vchDescriptionO'] != '') { ?>
                                            <a href="#myModalO<?php echo $row['intId']; ?>" role="button" data-toggle="modal">
                                            <?php $strMessage =  htmlspecialchars_decode($row['vchDescriptionO'], ENT_QUOTES); 
                                              echo $shortmsg = $objInfocus->wardWrap($strMessage, 100);
                                            ?></a>

                                            <div class="modal fade" id="myModalO<?php echo $row['intId']; ?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                                                <div class="modal-dialog modal-lg">
                                                    <div class="modal-content">
                                                        <div class="modal-header">
                                                             <button type="button" class="close" data-dismiss="modal"><span aria-hidden="true">&times;</span><span class="sr-only">Close</span></button>
                              ...
                              <?php } ?>   
                                ...
                                <td align="center" valign="middle" class="noPrint" style="<?php echo $editPriv; ?>"><a href="<?php echo APP_URL?>addInfocus/<?php echo $glId; ?>/<?php echo $plId; ?>/<?php echo $row['intId'] ?>" data-rel="tooltip" Name="" data-original-Name="Edit" class="btn btn-xs btn-info"> <i class="ace-icon fa fa-pencil bigger-120"></i> </a></td>
    ...
    <?php echo $objInfocus->getPageNumbers($intTotalRec, $intCurrPage, $intPgSize, $isPaging); ?>
                        </div>
                    </div>
    <?php if ($isPaging == 0 && $intTotalRec > $intPgSize) { ?>
                        <div class="col-xs-6">
                            <div class="dataTables_paginate paging_bootstrap">
                                <ul class="pagination">
        <?php echo $objInfocus->getPaging($intTotalRec, $intCurrPage, $intPgSize, $isPaging); ?>                    
                                </ul>
                            </div>
                        </div>
                <?php } ?>
