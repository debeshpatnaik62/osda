        ...
        <section class="container contarea">
            ...
            <div class="tabsec">
                <nav>
                    <div class="nav nav-tabs justify-content-center" id="nav-tab" role="tablist">
                        ...
                        <a class="nav-item nav-link <?php echo ($activeTab == 'employer') ? 'active' : ''; ?> <?php echo $odiaClass;?>" id="nav-Meet-tab" data-toggle="tab" href="#nav-Meet" role="tab" aria-controls="nav-Meet" aria-selected="false"><?php echo $strEmployerlbl;?></a>
                         ...
                         <!-- <a class="nav-item nav-link <?php echo ($activeTab == 'write') ? 'active' : ''; ?> <?php echo $odiaClass;?>" id="nav-write-tab" data-toggle="tab" href="<?php echo SITE_URL; ?>feedback" role="tab" aria-controls="nav-write" aria-selected="false">Write to Us</a> -->

                         <a class="nav-item nav-link <?php echo $odiaClass;?>" id="nav-write-tab" href="<?php echo SITE_URL; ?>feedback" role="tab" aria-controls="nav-write" aria-selected="false"><?php echo $studentbtn;?></a>
                ...
                <div class="tab-content" id="nav-tabContent">
                  ...
                  <!-- <div class="tab-pane fade <?php echo ($activeTab == 'write') ? 'show active' : ''; ?>" id="nav-write" role="tabpanel" aria-labelledby="nav-write-tab">
                        <h2 class="text-center <?php echo $odiaClass;?>"><?php echo $strTrainPartnerslbl;?></h2>
                        <div class="row box-shadow p-2 pt-4 pb-4 p-md-4 mt-4 mt-md-0 br-5 mt-md-4">
