               ...
               <div class="inNews__filter">
                    <div class="form-row">
                        <div class="form-group col-md-3 form--calendar">
                              ...
                              <input type="text" class="form-control datepicker <?php echo $strNumLangCls; ?> " data-date-format="dd-mm-yyyy" placeholder="DD-MM-YYYY" name="txtFromDate" id="txtFromDate"  value="<?php echo ($strFromDate!='0000-00-00')?date('d-m-Y',strtotime($strFromDate)):''; ?>">
                               <i class="fa fa-calendar"></i>
                        </div>
                        <div class="form-group col-md-3 form--calendar">
                             <label class="<?php echo $strLangCls; ?>"><?php echo $strToDatelbl; ?></label>
                           <input type="text" class="form-control datepicker <?php echo $strNumLangCls; ?> " data-date-format="dd-mm-yyyy" placeholder="DD-MM-YYYY" name="txtToDate" id="txtToDate"  value="<?php echo ($strToDate!='0000-00-00')?date('d-m-Y',strtotime($strToDate)):''; ?>">
                              <i class="fa fa-calendar"></i>
                        </div>
                        <div class="form-group col-md-4 ">
                           <label class="<?php echo $strLangCls; ?>"><?php echo $strNewsHeadlinelbl; ?></label>
                         <input type="text" class="form-control <?php echo $strLangCls; ?>" placeholder="<?php echo $strNewsHeadlinelbl; ?>" name="txtHeadline" id="txtHeadline" maxlength="100" value="<?php echo $strHeadline;?>">
                        </div>
                        <div class="form-group col-md-2">
                         <label></label>
                          <button name="btnSearch" value="btnSearch" class="osda--btn btn--rounded<?php echo $strLangCls; ?>"><?php echo $strSearchlbl; ?></button>
                        </div>
                    </div>
            ...
            <div class="col-12">
              <div class="row">
                  <?php if($result->num_rows > 0) { 
                        $intCounter      = 0; 
                        $strclsBorder    = '';
                 while($newsRow = $result->fetch_array()) {
                if($intCounter<1){
                   $intCounter++;                   
                   if($intCounter==$result->num_rows)
                    ...
                    $descCount    = ($_SESSION['lang']=='O' && $descO != '')?150:130;
                    ...
                    $image        =($newsRow['vchImageFile']!='') ?APP_URL . "uploadDocuments/news/" . $newsRow['vchImageFile']:SITE_URL.'images/no-image.jpg';
                    ...
                    $sourceHtml=($newsRow['intCategoryId']==2)?$vchSourcename:'<a href="'.$vchSource.'" target="_blank" title="">'.$vchSourcename.'</a>';
                    $headingLink= ($newsRow['intCategoryId']==2)?SITE_URL.'biswabijayee/'.$newsId:$vchSource;
                    $blankTab=($newsRow['intCategoryId']==2)?'':'target="_blank"';
                    ...
                    <div class="inNews__details">
                        ...
                        <span class="inNews__category <?php echo $vchSourcenameCls;?>"><?php echo ucfirst($vchNewsCategory);?></span>
                         <h3 class="inNews__headline <?php echo $headlineCls; ?>">
                            <a <?php echo $blankTab;?> href="<?php echo $headingLink;?>" title=""><?php echo $headline;?></a>
                         </h3>
                        <div class="inNews__meta">
                              <span class="inNews__meta__date <?php echo $strLangcls; ?> "><?php echo $newsDate; ?></span>
                               <?php if($vchSourcename!='' && $newsRow['intCategoryId']!=2){ ?>
                         ...
                         <div class="inNews__share">
                              <span class="inNews__share__handle"><i class="fa fa-share-alt"></i>
                                  <span class="inNews__share__icons sharing <?php echo $strNumLangCls; ?>" data-heading="<?php echo $headlineE; ?>" data-url="<?php echo $headingLink; ?>">
                                  </span>     
                              </span>
                         </div>
               ...
               <?php } else {?>
                         ...
                         <div class="inNews">
                              <div class="inNews__media">
                                   ...
                                   <a <?php echo $blankTab;?> href="<?php echo $headingLink;?>" title=""></a>
                              </div>
                              <div class="inNews__details">
                                  <span class="inNews__category <?php echo $vchSourcenameCls;?>"><?php echo ucfirst($vchNewsCategory);?></span>
                                   <h3 class="inNews__headline <?php echo $headlineCls; ?>">
                                   ...
                                   <div class="inNews__share">
                              <span class="inNews__share__handle"><i class="fa fa-share-alt"></i>
                                  <span class="inNews__share__icons sharing <?php echo $strNumLangCls; ?>" data-heading="<?php echo $headlineE; ?>" data-url="<?php echo $headingLink; ?>"></span>     
                              </span>
                         </div>
