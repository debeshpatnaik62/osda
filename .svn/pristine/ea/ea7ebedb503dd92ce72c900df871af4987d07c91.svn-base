...
<style type="text/css">
.st0 {stroke: #85398a;stroke-miterlimit: 10;}
.st1 {stroke: #85398a;stroke-miterlimit: 10;}
.st2 {stroke: #85398a;stroke-miterlimit: 10;}
.st4 {font-size: 9px;color: #000 !important;}
.st4sm {font-size: 8px;}
.leases {fill: #16172d;position: relative;cursor: pointer}
.leases:after {width: 0px;height: 0px;border-left: 20px solid transparent;border-right: 20px solid transparent;border-top: 20px solid #f00;}
.projects {fill: #CC1518;}
.vals {fill: #fff;font-size: 11px;cursor: pointer;text-align: center !important;text-anchor: middle;}
.dist-block.active {fill:#d7abda !important;}
.dist-block.active {background: #d7abda !important;}
.insbtn {margin-bottom: 15px;float: left;}
</style>
<!--start : css for IE 10+ -->
<style type="text/css">
@media all and (-ms-high-contrast: none),  (-ms-high-contrast: active) {
.mapBox {height: 700px !important;padding-bottom: 50px;}
}
</style>
...
<ul class="nav nav-pills" id="pills-tab" role="tablist">
  <li class="nav-item"> <a class="nav-link active <?php echo $strLangCls; ?>" id="pills-all-tab" data-toggle="pill" href="#pills-all" role="tab" aria-controls="pills-all" aria-selected="true"><?php echo $strListviewlbl; ?></a> </li>
  <li class="nav-item"> <a class="nav-link <?php echo $strLangCls; ?>" id="pills-Short-tab" data-toggle="pill" href="#pills-Short" role="tab" aria-controls="pills-Short" aria-selected="false"><?php echo $strMapviewlbl; ?></a> </li>
</ul>
<div class="tab-content" id="pills-tabContent">
  <div class="tab-pane fade show active" id="pills-all" role="tabpanel" aria-labelledby="pills-all-tab">
    <div class="row">
      <div class="col-sm-4">
        <div class="leftsec">
          <div class="togglesec">
            <div> <a class="tabheader" data-toggle="collapse" href="#distList" role="button" aria-expanded="false" aria-controls="longterm"><?php echo $filterDistLevel; ?><i class="fa fa-angle-down" aria-hidden="true"></i></a> </div>
            <div class="collapse show" id="distList"> </div>
          </div>
        </div>
      </div>
      <div class="col-sm-8 rightsec"> 
        
        <!--                        <h3><?php //echo $strPIAlbl;?></h3>-->
        <div id="listInstitute"> 
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-9">
                                        <div class="coursestext">
                                            ...
                                            <p>At/PO- Hatatote, Talcher District- Angul, Pin-759100</p>
                                            <div class="insbtn"><a href="#">Available Course</a></div> <div class="insbtn"><a href="#">institute Profile</a></div> 
  ...
  <div class="tab-pane fade" id="pills-Short" role="tabpanel" aria-labelledby="pills-Short-tab">
    <div class="row">
      <div class="col-sm-8">
        <h2 class="text-center screenreader <?php echo $strLangCls; ?>"> <?php echo $strOdishamaplbl; ?> <span class="inspagelabelno screenreader"> <?php echo $strInstCountinfo1; ?> <span class="<?php echo $strNumLangCls; ?>"> <?php echo $intTotalRec; ?> </span> <?php echo $strInstCountinfo3; ?> </span> </h2>
        <div class="mapBox">
          <svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 605 476" style="enable-background:new 0 0 605 476;" xml:space="preserve">
            <?php

							/* $counterArray = array(); 
							  if ($mapcount > 0) {

							  while ($distrow = $mapresult->fetch_array()) {
							  $counterArray[$distrow['intDistrictid']] =  $distrow['instituteCount'];

							  }
							  } */
							?>
            <path class="st0 dist-block <?php echo (in_array(21, $activeAry)) ? 'active' : '' ?>" fill="#feebff" id="21" data-distid="21" style="cursor:pointer;" onmouseout="$(this).attr('fill', '#f00')" d="M434.4,215.6h-0.9v0.9h-1.6v0.9h-0.8v0.8l-1.6,1.6v1.6l-0.8,0.8v0.9l-0.9,0.9l-1.6-0.1l0.1,0.9l-0.8,0.8h-0.9
            ...
            <path class="st0 dist-block <?php echo (in_array(18, $activeAry)) ? 'active' : '' ?>" fill="#feebff" id="18" data-distid="18" style="cursor:pointer;" onmouseover="$(this).attr('fill', '#ffde00')" onmouseout="$(this).attr('fill', '#cceaff')" d="M287.9,298v-2.8l0.8-0.9h0.8l0.8-0.8v-0.8l0.8-0.9h-1.6l-0.9-0.9l-0.9,0.1l-1.6-1.6v-1.6l-1.7-0.2v-0.9
            ...
            <path class="st0 dist-block <?php echo (in_array(24, $activeAry)) ? 'active' : '' ?>" fill="#feebff" id="24" data-distid="24" style="cursor:pointer;" onmouseover="$(this).attr('fill', '#ffde00')" onmouseout="$(this).attr('fill', '#cceaff')" d="M542.9,49.2l-1.7-0.9h-5.7v-0.9l-0.9-0.8h-0.8l-0.8-0.8v-0.9l-0.9-0.8l-0.1-1.6l-7.4,1.6l-0.1-4.9h0.9l-0.1-0.9
            ...
            <path class="st0 dist-block <?php echo (in_array(4, $activeAry)) ? 'active' : '' ?>" fill="#feebff" id="4" data-distid="4" style="cursor:pointer;" d="M566.9,61.8l-1.6,1.6l0.1,2.4l-0.9-0.9H563l-0.1-0.8h-0.8l-2.4,2.6l0.1,1.6l0.8,0.8l-0.8,0.8v0.9h0.9v0.9
            ...
            <path class="st0 dist-block <?php echo (in_array(6, $activeAry)) ? 'active' : '' ?>" fill="#feebff" id="6" data-distid="6" style="cursor:pointer;" onmouseover="$(this).attr('fill', '#ffde00')" onmouseout="$(this).attr('fill', '#cceaff')" d="M499.8,135.6l-1.5,1.6h-0.8v-0.8h-0.9l-0.9-0.9h-2.3l-1.6-1.6h-0.9l0.1,1.6l0.9,0.9H491l0.1,1.7l-1.7,1.6h-0.8
            ...
            <path class="st0 dist-block <?php echo (in_array(15, $activeAry)) ? 'active' : '' ?>" fill="#feebff" id="15" data-distid="15" style="cursor:pointer;" onmouseover="$(this).attr('fill', '#ffde00')" onmouseout="$(this).attr('fill', '#feebff')" d="M483.9,155.3l-1.6-1.6H479l-0.9-0.8h-2.5L474,152h-0.8l-0.9-0.8h-1.7l-0.9-1h-0.9l-0.7,0.9h-0.8l-2.4,2.5v1.6
            ...
            <path class="st0 dist-block <?php echo (in_array(11, $activeAry)) ? 'active' : '' ?>" fill="#feebff" id="11" data-distid="11" style="cursor:pointer;" onmouseover="$(this).attr('fill', '#ffde00')" onmouseout="$(this).attr('fill', '#feebff')" d="M430.2,142v-0.8h-1.6v-0.9l-2.5-0.1l-0.9,0.9h-0.7l-0.8,0.9l-3.4-0.1l0.1,0.9l-0.9,0.6h-0.9l-0.7,0.8l-1.6-0.8
            ...
            <path class="st0 dist-block <?php echo (in_array(9, $activeAry)) ? 'active' : '' ?>" fill="#feebff" id="9" data-distid="9" style="cursor:pointer;" onmouseover="$(this).attr('fill', '#ffde00')" onmouseout="$(this).attr('fill', '#feebff')" d="M456.2,190.7l-1.7-1.7l-1.6,0.1l-1.8-0.9h-0.8h-0.8v1.7l-1.6,1.7h-0.8l-0.9-1h-9.8l-0.7,0.9l0.1,2.5h-1.6
            ...
            <path class="st0 dist-block <?php echo (in_array(14, $activeAry)) ? 'active' : '' ?>" fill="#feebff" id="14" data-distid="14" style="cursor:pointer;" onmouseover="$(this).attr('fill', '#ffde00')" onmouseout="$(this).attr('fill', '#feebff')" d="M460.9,219.7v0.8l1.9,1.6l0.8,1.6l-0.5,1.6h0.9l-0.1,0.8l-0.8,0.8v0.9h0.8l1,0.8l-0.9,0.9h0.9v0.9l2.5,0.1v0.8
            ...
            <path class="st0 dist-block <?php echo (in_array(19, $activeAry)) ? 'active' : '' ?>" fill="#feebff" id="19" data-distid="19" style="cursor:pointer;" onmouseover="$(this).attr('fill', '#ffde00');" onmouseout="$(this).attr('fill', '#feebff')" d="M524,176.9h-4.2l-3.1,3.3l-2.6,0.2l-0.8,0.7l0.9,0.9v0.9l0.8,0.8l0.1,0.8h-0.9v0.9h-0.8l-0.8,0.7v0.9h-3.3v0.8
            ...
            <path class="st0 dist-block <?php echo (in_array(16, $activeAry)) ? 'active' : '' ?>" fill="#feebff" id="16" data-distid="16" style="cursor:pointer;" onmouseover="$(this).attr('fill', '#ffde00');" onmouseout="$(this).attr('fill', '#cceaff')" d="M295.8,57.2l-0.9-0.8h-0.6l-0.9-0.9h-8.2l0.2,3.3l-0.9,0.8l-1.6,0.9l-0.8,0.1l-0.8,0.9h-0.8l-1.6-1.8l-1.7-0.8
            ...
            <polygon class="st0 dist-block <?php echo (in_array(32, $activeAry)) ? 'active' : '' ?>" fill="#feebff" id="32" data-distid="32" style="cursor:pointer;" onmouseover="$(this).attr('fill', '#ffde00');" onmouseout="$(this).attr('fill', '#cceaff')" points="393.9,68.3 393.8,65.2 392,63.4 391.2,63.4 390.4,62.6 383,62.5 379.8,59.2 379.7,58.4 380.5,57.5 
            ...
            <path class="st0 dist-block <?php echo (in_array(5, $activeAry)) ? 'active' : '' ?>" fill="#feebff" id="5" data-distid="5" style="cursor:pointer;" onmouseover="$(this).attr('fill', '#ffde00');" onmouseout="$(this).attr('fill', '#cceaff')" d="M219,84.1l-0.8,0.8h-0.8v0.8l-0.8,0.9v0.9l-0.8,1.5v0.9l-1.5,1.6v0.8h-1.7l-0.8,1.7l0.9,0.7v0.9h-2.6l0.2,0.9
            ...
            <path class="st0 dist-block <?php echo (in_array(31, $activeAry)) ? 'active' : '' ?>" fill="#feebff" id="31" data-distid="31" style="cursor:pointer;" onmouseover="$(this).attr('fill', '#ffde00');" onmouseout="$(this).attr('fill', '#cceaff')" d="M240.7,142H239v0.7l-1.6,0.8l-0.8,0.8l-1.6,0.1v0.9l-1.6,1.6h-0.8l-0.8-0.9l-0.6-0.2l-2-0.6h-2.3l-0.8-0.9h-0.8
            ...
            <path class="st0 dist-block <?php echo (in_array(7, $activeAry)) ? 'active' : '' ?>" fill="#feebff" id="7" data-distid="7" style="cursor:pointer;" onmouseover="$(this).attr('fill', '#ffde00');" onmouseout="$(this).attr('fill', '#cceaff')" d="M145.2,172.1l-1.6,1.7l-0.8,1.6l-2.4,2.3v0.9l-0.8,1.6v0.9l-0.7,0.9v0.8h-2.5l-0.8,0.9v3.2l0.9,0.9l0.8,0.1
            ...
            <path class="st0 dist-block <?php echo (in_array(17, $activeAry)) ? 'active' : '' ?>" fill="#feebff" id="17" data-distid="17" style="cursor:pointer;" onmouseover="$(this).attr('fill', '#ffde00');" onmouseout="$(this).attr('fill', '#cceaff')" d="M156,240.5v-0.8h-7.4v0.8l-0.7,0.8v0.9l-0.8,0.9l0.1,0.7l-1.7,1.7h-0.8l-1.6,0.8h-1.8l-1.6,1.6h-0.8v0.9
            ...
            <polygon class="st0 dist-block <?php echo (in_array(8, $activeAry)) ? 'active' : '' ?>" fill="#feebff" id="8" data-distid="8" style="cursor:pointer;" onmouseover="$(this).attr('fill', '#ffde00');" onmouseout="$(this).attr('fill', '#cceaff')" points="310.8,220.7 312.9,220.2 312.9,219.9 312.8,217.4 313.7,217.4 315.2,215.7 316.4,215.7 316.4,215.7 
            ...
            <path class="st0 dist-block <?php echo (in_array(27, $activeAry)) ? 'active' : '' ?>" fill="#feebff" id="27" data-distid="27" style="cursor:pointer;" onmouseover="$(this).attr('fill', '#ffde00');" onmouseout="$(this).attr('fill', '#cceaff')" d="M102.3,166h-0.9v-0.8l-0.8,0.8l0.2,3.4l-0.9,0.9l0.9,1.7l0.3,13.8l1.7,1.7l0.1,6.7l-0.8,0.9l0.1,2.3h-0.8
            ...
            <path class="st0 dist-block <?php echo (in_array(25, $activeAry)) ? 'active' : '' ?>" fill="#feebff" id="25" data-distid="25" style="cursor:pointer;" onmouseover="$(this).attr('fill', '#ffde00');" onmouseout="$(this).attr('fill', '#cceaff')" d="M63.2,244.4h-2.3v0.8H60l-1.6,1.6l-0.8,1.7l-0.9,0.8h-1.4l-0.9,0.9l0.1,2.5l-0.8,0.8v1.6L53,256v1.6l-0.8,0.9
                                  ...
                                  L63.2,244.4z"/>
            <path class="st0 dist-block <?php echo (in_array(22, $activeAry)) ? 'active' : '' ?>" fill="#feebff" id="22" data-distid="22" style="cursor:pointer;" onmouseover="$(this).attr('fill', '#ffde00');" onmouseout="$(this).attr('fill', '#cceaff')" d="M89.7,342.5l-0.7-0.1l0.7,0.9l0.1,2.5l-0.7,0.8l2.4,5.1l0.2,7.4h0.9l0.1,3.2H91l-1.5-0.8h-1.7l-1.6,0.8
            ...
            <path class="st0 dist-block <?php echo (in_array(23, $activeAry)) ? 'active' : '' ?>" fill="#feebff" id="23" data-distid="23" style="cursor:pointer;" onmouseover="$(this).attr('fill', '#ffde00');" onmouseout="$(this).attr('fill', '#cceaff')" d="M59.1,397.5l0.8,0.9l0.1,0.8h-1.6l-0.8,0.9h-0.8l-0.9,0.6h-0.8v1.8l-0.8,0.8v0.9h-0.7l-3.3,3.3l-1.6,0.8
                                  ...
                                  L59.1,397.5z"/>
            <path class="st0 dist-block <?php echo (in_array(29, $activeAry)) ? 'active' : '' ?>" fill="#feebff" id="29" data-distid="29" style="cursor:pointer;" onmouseover="$(this).attr('fill', '#ffde00');" onmouseout="$(this).attr('fill', '#cceaff')" d="M221.6,262.3l-1.8-1.6h-0.9l-0.8-1h-1.7l-0.8-0.8H214l-0.9-0.9h-2.3v2.6l-0.8,0.9v0.8h-1.7l-0.8,0.8l0.1,3.1
            ...
            <g>
              <g>
                <g>
                  <path class="st0 dist-block <?php echo (in_array(30, $activeAry)) ? 'active' : '' ?>" fill="#feebff" id="30" data-distid="30" style="cursor:pointer;" onmouseover="$(this).attr('fill', '#ffde00');" onmouseout="$(this).attr('fill', '#cceaff')" d="M288.7,167.8h-0.8l-0.8-1.7l-0.9-0.8v-0.8h-0.9l-0.8-0.9l-0.2-0.8l-1.6-1.7h-0.8l-0.9-0.8l-2.4-0.2v-0.8
            ...
            <path class="st0 dist-block <?php echo (in_array(10, $activeAry)) ? 'active' : '' ?>" fill="#feebff" id="10" data-distid="10" style="cursor:pointer;" onmouseover="$(this).attr('fill', '#ffde00');" onmouseout="$(this).attr('fill', '#cceaff')" d="M321.6,84.4l-0.8,0.4l0.9,1.3l-0.5,1l-1.3,0.3c0,0-1,0.6-1.1,0.6s-4.7,0-4.7,0l-1.7,1.7l-4.1,0.1l-0.8-0.9v0.8
            ...
            <path class="st0 dist-block <?php echo (in_array(13, $activeAry)) ? 'active' : '' ?>" fill="#feebff" id="13" data-distid="13" style="cursor:pointer;" onmouseover="$(this).attr('fill', '#ffde00');" onmouseout="$(this).attr('fill', '#cceaff')" d="M288.5,298l1.1,0.1v0.8v0.8h0.8h1.6l0.8-0.8v-0.8l1.6-1.6v-0.8l0.9-0.9v0.8l0.9,0.8l0.1,0.8h5.8v0.8h0.8
            ...
            <path class="st0 dist-block <?php echo (in_array(12, $activeAry)) ? 'active' : '' ?>" fill="#feebff" id="12" data-distid="12" style="cursor:pointer;" onmouseover="$(this).attr('fill', '#ffde00');" onmouseout="$(this).attr('fill', '#cceaff')" d="M244.3,356.4l2.1-2.4h0.9v-0.8l0.8-0.7l1.6-0.9v0.8l0.9,0.8h0.9v0.8l0.8,0.9l0.8,0.1l1.7,1.6l2.5-0.1l-0.1-2.6
            ...
            <path class="st0 dist-block <?php echo (in_array(28, $activeAry)) ? 'active' : '' ?>" fill="#feebff" id="28" data-distid="28" style="cursor:pointer;" onmouseover="$(this).attr('fill', '#ffde00');" onmouseout="$(this).attr('fill', '#cceaff')" d="M468,245.2l-1.3,0.1l-1.7,0.9l-0.8-0.9h-4l-0.9-0.8h-0.9l-0.6,0.8h-0.9v0.9l-1.6-0.2l-0.1-2.5l-1.6,0.1
            ...
            <path class="st0 dist-block <?php echo (in_array(26, $activeAry)) ? 'active' : '' ?>" fill="#feebff" id="26" data-distid="26" style="cursor:pointer;" onmouseover="$(this).attr('fill', '#ffde00');" onmouseout="$(this).attr('fill', '#cceaff')" d="M333.2,204.2l-0.7,0.9v0.8l-0.8,1.6l-0.8,2.5l-0.8,0.8l0.9,0.9l0.9,1.6H331l-0.8,0.8h-0.9l-0.8,0.9h-4.1
            ...
            <path class="st1 dist-block <?php echo (in_array(20, $activeAry)) ? 'active' : '' ?>" fill="#feebff" id="20" data-distid="20" style="cursor:pointer;" onmouseover="$(this).attr('fill', '#ffde00');" onmouseout="$(this).attr('fill', '#cceaff')" d="M491.7,133.9V133h0.7l0.8-0.7h-0.9v-0.8l-0.7-0.9v-0.8h-0.9l-0.1-2.4v-0.9l0.9-0.8l-0.1-0.8l-0.9-1v-0.7h-0.8
            ...
            <path class="st2 dist-block <?php echo (in_array(3, $activeAry)) ? 'active' : '' ?>" fill="#feebff" id="3" data-distid="3" style="cursor:pointer;" onmouseover="$(this).attr('fill', '#ffde00');" onmouseout="$(this).attr('fill', '#cceaff')" d="M398.1,139.1l-1.6-1.7l-0.1-1.6l0,0v-0.1l-1.5-1.3l0,0l-0.3-0.3c0,0-0.5-0.3-1.1-0.7l0,0l0,0
            ...
            <g>
              <g>
                <text transform="matrix(1 0 0 1 402.107 239.2757)" class="st3 st4 dist-name <?php echo $strLangCls; ?>" data-distid="21" style="cursor:pointer;"> <?php echo $strKhurda; ?> </text>
                <text transform="matrix(1 0 0 1 432.9157 268.0657)" class="st3 st4 dist-name <?php echo $strLangCls; ?>" data-distid="28" style="cursor:pointer;" onmouseover="$('#Puri').attr('fill', '#ffde00');" onmouseout="$('#Puri').attr('fill', '#cceaff')"> <?php echo $strPuri; ?> </text>
                <text transform="matrix(1 0 0 1 316.9899 295.0952)" class="st3 st4 dist-name <?php echo $strLangCls; ?>" data-distid="13" style="cursor:pointer;" onmouseover="$('#Ganjam').attr('fill', '#ffde00');" onmouseout="$('#Ganjam').attr('fill', '#cceaff')"> <?php echo $strGanjam; ?> </text>
                <text transform="matrix(1 0 0 1 264.3942 363.8353)" class="st3 st4 dist-name <?php echo $strLangCls; ?>" data-distid="12" style="cursor:pointer;" onmouseover="$('#Gajapati').attr('fill', '#ffde00');" onmouseout="$('#Gajapati').attr('fill', '#cceaff')"> <?php echo $strGajapati; ?> </text>
                <text transform="matrix(1 0 0 1 201.5895 319.6087)" class="st3 st4 dist-name <?php echo $strLangCls; ?>" data-distid="29" style="cursor:pointer;" onmouseover="$('#Rayagada').attr('fill', '#ffde00');" onmouseout="$('#Rayagada').attr('fill', '#cceaff')"> <?php echo $strRayagada; ?> </text>
                <text transform="matrix(1 0 0 1 148.5607 270.5785)" class="st3 st4 dist-name <?php echo $strLangCls; ?>" data-distid="17" style="cursor:pointer;" onmouseover="$('#Kalahandi').attr('fill', '#ffde00');" onmouseout="$('#Kalahandi').attr('fill', '#cceaff')"> <?php echo $strKalahandi; ?> </text>
                <text transform="matrix(1 0 0 1 160.0309 199.3095)" class="st3 st4 dist-name <?php echo $strLangCls; ?>" data-distid="7" style="cursor:pointer;" onmouseover="$('#Balangir').attr('fill', '#ffde00');" onmouseout="$('#Balangir').attr('fill', '#cceaff')"> <?php echo $strBolangir; ?> </text>
                <text transform="matrix(1 0 0 1 110.6866 230.3802)" class="st3 st4 dist-name <?php echo $strLangCls; ?>" data-distid="27" style="cursor:pointer;" onmouseover="$('#Nuapada').attr('fill', '#ffde00');" onmouseout="$('#Nuapada').attr('fill', '#cceaff')"> <?php echo $strNuapada; ?> </text>
                <text transform="matrix(1 0 0 1 231.8189 165.8046)" class="st3 st4 dist-name <?php echo $strLangCls; ?>" data-distid="31" style="cursor:pointer;" onmouseover="$('#Sonepur').attr('fill', '#ffde00');" onmouseout="$('#Sonepur').attr('fill', '#cceaff')"> <?php echo $strSonepur; ?> </text>
                <text transform="matrix(1 0 0 1 259.3682 128.2737)" class="st3 st4 dist-name <?php echo $strLangCls; ?>" data-distid="30" style="cursor:pointer;" onmouseover="$('#Sambalpur').attr('fill', '#ffde00');" onmouseout="$('#Sambalpur').attr('fill', '#cceaff')"> <?php echo $strSambalpur; ?> </text>
                <text transform="matrix(1 0 0 1 241.8189 77.1869)" class="st3 st4 dist-name <?php echo $strLangCls; ?>" data-distid="16" style="cursor:pointer;" onmouseover="$('#Jharsuguda').attr('fill', '#ffde00');" onmouseout="$('#Jharsuguda').attr('fill', '#cceaff')"> <?php echo $strJharsuguda; ?> </text>
                <text transform="matrix(1 0 0 1 282.2395 35.1303)" class="st3 st4 st4 dist-name <?php echo $strLangCls; ?>" data-distid="32" style="cursor:pointer;" onmouseover="$('#Sundargarh').attr('fill', '#ffde00');" onmouseout="$('#Sundargarh').attr('fill', '#cceaff')"> <?php echo $strSundargarh; ?> </text>
                <text transform="matrix(1 0 0 1 318.9567 113.5317)" class="st3 st4 dist-name <?php echo $strLangCls; ?>" data-distid="10" style="cursor:pointer;" onmouseover="$('#Deogarh').attr('fill', '#ffde00');" onmouseout="$('#Deogarh').attr('fill', '#cceaff')"> <?php echo $strDeogarh; ?> </text>
                <text transform="matrix(1 0 0 1 402.8199 104.4524)" class="st3 st4 dist-name <?php echo $strLangCls; ?>" data-distid="20" style="cursor:pointer;" onmouseover="$('#Keonjhar').attr('fill', '#ffde00');" onmouseout="$('#Keonjhar').attr('fill', '#cceaff')"> <?php echo $strKeonjhar; ?> </text>
                <text transform="matrix(1 0 0 1 333.3239 168.3176)" class="st3 st4 dist-name <?php echo $strLangCls; ?>" data-distid="3" style="cursor:pointer;" onmouseover="$('#Anugul').attr('fill', '#ffde00');" onmouseout="$('#Anugul').attr('fill', '#cceaff')"> <?php echo $strAnugul; ?> </text>
                <text transform="matrix(1 0 0 1 256.2622 189.0903)" class="st3 st4 dist-name <?php echo $strLangCls; ?>" data-distid="8" style="cursor:pointer;" onmouseover="$('#Boudha').attr('fill', '#ffde00');" onmouseout="$('#Boudha').attr('fill', '#cceaff')"> <?php echo $strBoudh; ?> </text>
                <text transform="matrix(1 0 0 1 341.4724 230.8627)" class="st3 st4 dist-name <?php echo $strLangCls; ?>" data-distid="26" style="cursor:pointer;" onmouseover="$('#Nayagarh').attr('fill', '#ffde00');" onmouseout="$('#Nayagarh').attr('fill', '#cceaff')"> <?php echo $strNayagarh; ?> </text>
                <text transform="matrix(1 0 0 1 432.2613 208.8428)" class="st3 st4 dist-name <?php echo $strLangCls; ?>" data-distid="9" style="cursor:pointer;" onmouseover="$('#Cuttack').attr('fill', '#ffde00');" onmouseout="$('#Cuttack').attr('fill', '#cceaff')"> <?php echo $strCuttack; ?> </text>
                <text transform="matrix(1 0 0 1 491.0933 205.8925)" class="st3 st4 st4sm dist-name <?php echo $strLangCls; ?>" data-distid="19" style="cursor:pointer;" onmouseover="$('#Kendrapada').attr('fill', '#ffde00');" onmouseout="$('#Kendrapada').attr('fill', '#cceaff')"> <?php echo $strKendrapara; ?> </text>
                <text transform="matrix(1 0 0 1 469.062 230.2699)" class="st3 st4 st4sm dist-name <?php echo $strLangCls; ?>" data-distid="14" style="cursor:pointer;" onmouseover="$('#Jagatsinghpur').attr('fill', '#ffde00');" onmouseout="$('#Jagatsinghpur').attr('fill', '#cceaff')"> <?php echo $strJagatsinghpur; ?> </text>
                <text transform="matrix(1 0 0 1 503.8237 163.3569)" class="st3 st4 dist-name <?php echo $strLangCls; ?>" data-distid="6" style="cursor:pointer;" onmouseover="$('#Bhadrak').attr('fill', '#ffde00');" onmouseout="$('#Bhadrak').attr('fill', '#cceaff')"> <?php echo $strBhadrak; ?> </text>
                <text transform="matrix(1 0 0 1 464.3258 180.4526)" class="st3 st4 dist-name <?php echo $strLangCls; ?>" data-distid="15" style="cursor:pointer;" onmouseover="$('#Jajpur').attr('fill', '#ffde00');" onmouseout="$('#Jajpur').attr('fill', '#cceaff')"> <?php echo $strJajpur; ?> </text>
                <text transform="matrix(1 0 0 1 393.0523 177.9398)" class="st3 st4 dist-name <?php echo $strLangCls; ?>" data-distid="11" style="cursor:pointer;" onmouseover="$('#Dhenkanal').attr('fill', '#ffde00');" onmouseout="$('#Dhenkanal').attr('fill', '#cceaff')"> <?php echo $strDhenkanal; ?> </text>
                <text transform="matrix(1 0 0 1 122.2614 377.5619)" class="st3 st4 dist-name <?php echo $strLangCls; ?>" data-distid="22" style="cursor:pointer;" onmouseover="$('#Koraput').attr('fill', '#ffde00');" onmouseout="$('#Koraput').attr('fill', '#cceaff')"> <?php echo $strKoraput; ?> </text>
                <text transform="matrix(1 0 0 1 40.003 433.6204)" class="st3 st4 dist-name <?php echo $strLangCls; ?>" data-distid="23" style="cursor:pointer;" onmouseover="$('#Malkangiri').attr('fill', '#ffde00');" onmouseout="$('#Malkangiri').attr('fill', '#cceaff')"> <?php echo $strMalkangiri; ?> </text>
                <text transform="matrix(1 0 0 1 88.7032 329.7337)" class="st3 st4 dist-name <?php echo $strLangCls; ?>" data-distid="25" style="cursor:pointer;" onmouseover="$('#Nabarangapur').attr('fill', '#ffde00');" onmouseout="$('#Nabarangapur').attr('fill', '#cceaff')"> <?php echo $strNabrangpur; ?> </text>
                <text transform="matrix(1 0 0 1 468.9938 71.395)" class="st3 st4 dist-name <?php echo $strLangCls; ?>" data-distid="24" style="cursor:pointer;" onmouseover="$('#Mayurbhanj').attr('fill', '#ffde00');" onmouseout="$('#Mayurbhanj').attr('fill', '#cceaff')"> <?php echo $strMayurbhanj; ?> </text>
                <text transform="matrix(1 0 0 1 511.6813 119.8607)" class="st3 st4 dist-name <?php echo $strLangCls; ?>" data-distid="4" style="cursor:pointer;" onmouseover="$('#Balasore').attr('fill', '#ffde00');" onmouseout="$('#Balasore').attr('fill', '#cceaff')"> <?php echo $strBalasore; ?> </text>
                <text transform="matrix(1 0 0 1 201.5895 133.9065)" class="st3 st4 dist-name <?php echo $strLangCls; ?>" data-distid="5" style="cursor:pointer;" onmouseover="$('#Bargarh').attr('fill', '#ffde00');" onmouseout="$('#Bargarh').attr('fill', '#cceaff')"> <?php echo $strBargarh; ?> </text>
                <text transform="matrix(1 0 0 1 248.405 247.9085)" class="st3 st4 dist-name <?php echo $strLangCls; ?>" data-distid="18" style="cursor:pointer;" onmouseover="$('#Kandhamal').attr('fill', '#ffde00');" onmouseout="$('#Kandhamal').attr('fill', '#cceaff')"> <?php echo $strKandhamal; ?> </text>
              </g>
              <g>
                <?php
									if ( $mapcount > 0 ) {
										//  mysqli_data_seek($mapresult, 0);
										while ( $distrow = $mapresult->fetch_array() ) {

											if ( $distrow[ 'instituteCount' ] > 0 ) {
												?>
                <circle class="leases " id="dist_<?php echo $distrow['intDistrictid']; ?>" data-distid="<?php echo $distrow['intDistrictid']; ?>" cx="<?php echo $distrow['vchSvgcx']; ?>" cy="<?php echo $distrow['vchSvgcy']; ?>" r="7.3"/>
                <text transform="<?php echo $distrow['vchSvgTransform']; ?>" data-distid="<?php echo $distrow['intDistrictid']; ?>" class="vals <?php echo $strNumLangCls; ?>" text-anchor="middle" x="5" y="1"> <?php echo $distrow['instituteCount']; ?> </text>
                <?php
									}
									}
									}
      ...
      <div class="col-sm-4">
        <h2 class="text-center screenreader <?php echo $strLangCls; ?>"> <?php echo $strDistInstlbl; ?> </h2>
        <div class="panel-group distaccordian" id="accordion"> </div>
      </div>
    </div>
  </div>
</div>
</section>
<span id="chkDistArray" style="display:none"></span> 
<!-- PIA course Modal -->
<div class="modal fade" id="piacourseModal" role="dialog">
  <div class="modal-dialog modal-lg"> 
    
    <!-- Modal content-->
    <div class="modal-content">
      <div class="modal-header">
        <h4 class="modal-title <?php echo $strLangCls; ?>"> <?php echo $strCourseDetailslbl; ?><strong>Institute Name</strong> </h4>
        <button type="button" class="close" data-dismiss="modal">&times;</button>
      </div>
      <div class="modal-body" id="courseModalContent"> </div>
    </div>
  </div>
</div>
<!--end:: contarea--> 
...
<script type="text/javascript">
	$( function () {
		...
		$( document ).on( "click", ".courseClick", function ( e ) {
			var id = $( this ).data( 'id' );
			var name = $( this ).data( 'name' );
			if ( "<?php echo $_SESSION['lang'] ?>" == 'O' ) {
				$( '#piacourseModal .modal-title' ).html( '<?php echo $strCourseDetailslbl; ?>' + ' : ' + '<strong>' + name + '</strong>' );

			} else {
				$( '#piacourseModal .modal-title' ).html( '<?php echo $strCourseDetailslbl; ?>' + ' of ' + '<strong>' + name + '</strong>' );
			}
			loadInstituteCourses( 'courseModalContent', id, 0 );

		} );
		$( '.district-details .districtdesc ul' ).on( 'click', function () {
			//alert('hi');
			$( '.district-details' ).addClass( 'overlapbox' );
		} );
		$( '.districtname ul' ).click( function () {
			//alert('hello');
			$( '.district-details' ).removeClass( 'overlapbox' );
		} );

		/************Start : FOr map  VIew****************/
		<?php if ($intCourseId > 0) { ?>
		...
		$( 'h4.panel-title' ).each( function () {
			if ( $( this ).parents().next( '.panel-collapse' ).hasClass( 'show' ) == true ) {
		...
		//load the the districts


		//load the district wise institute details
		loadDistwiseInstitute( 'accordion', '<?php echo $intDistrict; ?>', '<?php echo $strInstitute; ?>', '<?php echo $intCourseId; ?>', '<?php echo $intPIAStatus; ?>' );
		fillDistwiseInstituteLists( 'listInstitute', '', '', '<?php echo $intPIAStatus; ?>', '<?php echo $intCourseId; ?>' )
		$( '.dist-block ,.dist-name,.leases,.vals' ).click( function ( e ) {
			var distid = $( this ).data( 'distid' );

			var allcls = '';


			if ( ( '<?php echo $intCourseId; ?>' == 0 ) ) {

				//remove the other active classes
				$( ".dist-block" ).each( function () {
					allcls = $( this ).attr( 'class' ).replace( 'active', '' );
					$( this ).attr( 'class', allcls );
				} );

				//add the active class to the cureent element
				var cls = $( "#" + distid ).attr( 'class' ).replace( 'active', '' ) + ' active';
				$( "#" + distid ).attr( 'class', cls );

				$( "#hdnDdlDistrict" ).val( distid );
				//load the result
				loadDistwiseInstitute( 'accordion', distid, '<?php echo $strInstitute; ?>', '<?php echo $intCourseId; ?>', '<?php echo $intPIAStatus; ?>' );
		...
		$( ".dist-block" ).mouseover( function () {
			$( this ).css( "fill", "#db9fde" );
		} );

		/* Block Hovers */
		$( ".dist-block" ).mouseleave( function () {
			$( this ).css( "fill", "#feebff" );
		} );
		...
		fillDistrictLists( '<?php echo $intDistrict; ?>', 'distList', '<?php echo $strInstitute; ?>', '<?php echo $intPIAStatus; ?>', '<?php echo $intCourseId; ?>' );
	...
	function getDistInstitutes( instCount ) {
		/* declare an checkbox array */


		var chkSelDistArray = '';
		var chkFilterDistArray = '';
		var chkDistArray = '';


		$( ".distListChk:checked" ).each( function () {
			// console.log(chkSelSectorArray+'sdfsd'+$(this).val())
			chkSelDistArray += ',' + $( this ).val();
		} );


		if ( $( ".distListChk:checked" ).length == 0 )
			$( '#chkDistArray' ).html( '' );

		chkSelDistArray = chkSelDistArray.replace( /(^[,\s]+)|([,\s]+$)/g, '' );
		chkDistArray = ( ( chkSelDistArray != '' && chkSelDistArray != undefined ) ? chkSelDistArray.replace( /(^[,\s]+)|([,\s]+$)/g, '' ) : '' );

		if ( chkDistArray != '' && chkDistArray != undefined )
			$( '#chkDistArray' ).html( ( ( chkDistArray.length > 0 ) ? chkDistArray : '' ) );

		chkFilterDistArray = $( '#chkDistArray' ).html();

		/* check if there is selected checkboxes, by default the length is 1 as it contains one single comma */
		fillDistwiseInstituteLists( 'listInstitute', chkFilterDistArray, '', '<?php echo $intPIAStatus; ?>', 0 )
