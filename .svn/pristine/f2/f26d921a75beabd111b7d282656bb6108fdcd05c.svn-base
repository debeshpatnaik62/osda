	...
	if($isPaging==0 && $_REQUEST['hdn_PageNo']=='' && $_REQUEST['ID']>0)
	{
       ...
       try{
               ...
               if(isset($_REQUEST['hdn_qs'])&& $_REQUEST['hdn_qs']!='' )
               {
                       ...
                       $outMsg	= $objNews->deleteSkillNews($qs,$ids);
               }
               if($isPaging==0)	
                   $result		= $objNews->manageSkillNews('PG',$intRecno,$newsCat,$strHeadlineE,'','', '0000-00-00 00:00:00','0000-00-00 00:00:00','','',0,0,0,$strStartDt,$strEndDate,'','','','','');
               ...
               else
               {
                   $intPgno	= 1;
                   $intRecno	= 0;
                   $result                 = $objNews->manageSkillNews('V',0,$newsCat,$strHeadlineE,'','', '0000-00-00 00:00:00','0000-00-00 00:00:00','','',0,0,0,$strStartDt,$strEndDate,'','','','','');
               }
              $totalResult                 = $objNews->manageSkillNews('V',0,$newsCat,$strHeadlineE,'','', '0000-00-00 00:00:00','0000-00-00 00:00:00','','',0,0,0,$strStartDt,$strEndDate,'','','','','');
