<?php
/* ================================================
  File Name           : addPanelVenue.php
  Description         : This is used for add Panel Venue details.
  Designed By         :
  Designed On         : 
  Devloped By         : Rahul Kumar Saw
  Devloped On         : 13-June-2022
  Update History      : <Updated by>        <Updated On>        <Remarks>
  Style sheet         : 
  Javscript Functions : ckeditor.js, validatorchklist.js
  includes            : util.php,addPanelVenueInner.php           :

  ================================================== */

require 'addPanelVenueInner.php';
?>
<script src="<?php echo APP_URL; ?>js/validatorchklist.js"></script>
<script language="javascript">
    $(document).ready(function () {
        
        pageHeader   = "<?php echo $strTab; ?> Panel Venue";
        strFirstLink = "Manage Skill Competition";
        strLastLink  = "Venue"; 
        loadNavigation('<?php echo $strTab; ?> Panel Venue');
     ...
     //function to validate the employee directory
        ...
        {     
            ...
            if(!selectDropdown('selLevel', 'Select Venue Level'))
             return false; 
    ...
    <div class="row">
        <div class="col-xs-12">
            ...
            <div class="top_tab_container"> 
                ...
                <a href="<?php echo APP_URL; ?>viewPanelVenue/<?php echo $glId; ?>/<?php echo $plId; ?>" class="btn btn-info">View</a>
            </div>
