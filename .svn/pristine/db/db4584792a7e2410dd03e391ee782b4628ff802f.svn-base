...
/* ================================================
  ...
  ================================================== */
    require("viewTickerInner.php");
?>

<script language="javascript">
    $(document).ready(function () {
        loadNavigation('View Ticker');
        pageHeader      = "View Ticker";
        strFirstLink    = "Manage Application";
        strLastLink     = "View Ticker";
    ...
    <div class="row">
        <div class="col-xs-12">
            ...
            <div class="top_tab_container">
              ...
              <a href="<?php echo APP_URL ?>addTicker/<?php echo $glId; ?>/<?php echo $plId; ?>" class="btn btn-info">Add</a> 
...
<!-- 
           ...
           <div class="legandBox">			
                <span class="greenLegend">&nbsp;</span>Published Ticker(s) &nbsp;			
                <span class="yellowLegend">&nbsp;</span> Unpublished Ticker(s) &nbsp;
            </div> 
             <div id="viewTable">
                    ...
                    <table class="table  table-bordered table-hover">
                        <thead>
                            <tr>
                                ...
                                <th width="20">Sl.#</th>
                                <th>English Ticker Message </th>  
                                <th>Odia Ticker Message </th>  
                                <th>Ticker URL</th>                                 
                                <th>Created On </th>
                         ...
                         ?>
                            <tr>
                               ...
                               <td>
                                ...
                                <td> 
                                    <?php echo htmlspecialchars_decode($row['vchTickerName'],ENT_QUOTES); ?>
                                </td>
                              
                                <td><?php  echo htmlspecialchars_decode($row['vchTickerNameO'],ENT_QUOTES);?> </td>  
                                <td><?php  echo htmlspecialchars_decode($row['vchTickerUrl'],ENT_QUOTES);?> </td>  
                                <td><?php echo date("d-M-Y",strtotime($row['stmCreatedOn']));?></td>
                                
                               <td align="center" valign="middle" class="noPrint" style="<?php echo $editPriv; ?>"><a href="<?php echo APP_URL?>addTicker/<?php echo $glId; ?>/<?php echo $plId; ?>/<?php echo $row['intId'] ?>" data-rel="tooltip" title="" data-original-title="Edit" class="btn btn-xs btn-info"> <i class="ace-icon fa fa-pencil bigger-120"></i> </a></td>
                            </tr>
                        <?php } ?>
                         </tbody>
                    </table>
                ...
                <div class="row noPrint">
                    <div class="col-xs-6">
                        <div class="dataTables_info" id="sample-table-2_info">
                            ...
                            <?php echo $objTicker->getPageNumbers($intTotalRec, $intCurrPage, $intPgSize, $isPaging); ?>
                        </div>
                    </div>
                     <?php if ($isPaging == 0 && $intTotalRec > $intPgSize) { ?>
                        <div class="col-xs-6">
                            <div class="dataTables_paginate paging_bootstrap">
                                <ul class="pagination">
                                <?php echo $objTicker->getPaging($intTotalRec, $intCurrPage, $intPgSize, $isPaging); ?>                    
                                </ul>
                            </div>
                        </div>
                <?php } ?>
