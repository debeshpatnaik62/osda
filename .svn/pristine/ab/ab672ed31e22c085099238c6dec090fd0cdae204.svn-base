    ...
    // exit("$strType");
       ...
       try{
            ...
            //print_r($COuntresultRow);exit;
               ...
               if($isPaging==0)	
                   $result		= $objReport->manageReport('PGR', $intRecno, $intQualification,$strType,'','', '1000-01-01',0,$regdType,$userId,$strStartDt,$strEndDate);

               else
               {
                   $intPgno	= 1;
                   $intRecno	= 0;
                   $result                 = $objReport->manageReport('RAL',$reportId, $intQualification,$strType,'','', '1000-01-01',0,$regdType,$userId,$strStartDt,$strEndDate);
                  //print_r( $result);exit; 
               }
              $totalResult                 = $objReport->manageReport('RAL',$reportId, $intQualification,$strType,'','', '1000-01-01',0,$regdType,$userId,$strStartDt,$strEndDate);
