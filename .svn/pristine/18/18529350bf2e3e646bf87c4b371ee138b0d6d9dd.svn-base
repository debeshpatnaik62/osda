<?php
    /* ================================================
    File Name         	  : viewPolytechnicReport.php
    Description		      : This is used for view Engineerring College Report.
    ...
    Style sheet           : 
    Javscript Functions   : 
    includes		  : util.php, viewITIReport.php

    ==================================================*/
    require 'viewPolytechnicReportInner.php';
?>
<script src="<?php echo APP_URL; ?>js/validatorchklist.js"></script>
<script language="javascript">
	$(document).ready(function () {
            loadNavigation('Polytechnic Report');
            pageHeader      = "Polytechnic Report";
            strFirstLink    = "Manage Reports";
            strLastLink     = "Polytechnic Report";
            downloadMe      ='yes';
    ...
    <div class="page-content">
        ...
        <div class="row">
            ...
            <div class="top_tab_container">
                ...
                <a href="javascript:void(0);" class="btn btn-info active">Polytechnics <span class="badge badge-danger"><?php echo $polyCount;?></span></a>
              ...
              <div class="form-group">
                        ...
                        <div class="col-sm-2"> 
                            ...
                            <select class="form-control" name="selType" id="selType" >
                                <option  <?php if( $strType=='3,4') echo 'selected="selected"';?> value="0">--All--</option>
                                <option  <?php if( $strType=='3') echo 'selected="selected"';?> value="3">Govt.</option>
                                <option  <?php  if( $strType=='4') echo 'selected="selected"';?> value="4">Private</option>
                            </select>
                ...
                <?php if (mysqli_num_rows($result) > 0) {
                    ...
                    <input name="hdn_qualification" id="hdn_qualify" type="hidden" value="20"/>
                <?php } else { ?>
