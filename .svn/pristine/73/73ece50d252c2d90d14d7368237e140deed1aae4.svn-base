<?php
    ...
    Description		: This page is used to view archieved success story details.
    ...
    //============ Search Function ========================//
        ...
        try{
            ...
            if($isPaging==0)	
                $result                 = $objStory->manageStory('PG',$intRecno,$strName,'','','','','','','','',$intInst,'','','','','',0,1,0,$intPgSize,0);
            else                                    
            {
                $intPgno                = 1;
                $intRecno               = 0;
                $result                 = $objStory->manageStory('V',0,$strName,'','','','','','','','',$intInst,'','','','','',0,1,0,0,0);
            }
           $totalResult                 = $objStory->manageStory('CT',0,$strName,'','','','','','','','',$intInst,'','','','','',0,1,0,0,0);
