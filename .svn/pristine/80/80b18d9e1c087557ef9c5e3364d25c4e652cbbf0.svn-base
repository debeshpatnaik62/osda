<?php
    ...
    require 'viewCareerInner.php';
?>
<script src="<?php echo APP_URL; ?>js/validatorchklist.js"></script>
<script language="javascript">
	$(document).ready(function () {
		pageHeader = "View Career";
                strFirstLink = "Manage Application";
                strLastLink = "Career";
               loadNavigation('View Career');
                ...
                <div class="searchTable">
                    <div class="form-group">
                        ...
                        <div class="col-sm-2">
                            ...
                            <input class="btn btn-danger" name="btnClear" type="button" value="Clear" onclick="window.location.href ='<?php echo APP_URL; ?>viewCareer/<?php echo $glId . '/' . $plId; ?>' ">
                        </div>
                    </div>
                </div>
                <div class="legandBox">			
                    <span class="greenLegend">&nbsp;</span>Published Career(s)&nbsp;			
                    <span class="yellowLegend">&nbsp;</span> Unpublished Career(s) &nbsp;
                </div>
                <div id="viewTable">
                    ...
                    <table class="table  table-bordered table-hover">
                        <thead>
                            <tr>
                                ...
                                <th width="20">Sl.#</th>
                                <th>Career Name (English)</th>    
                                <th>Career Name (Odia)</th>
                                <th>Ticker Name (English)</th>
                                <th>External Link </th>
                                <th>Start Date</th>
                                <th>End Date</th>
                                <th>Document</th>
                        ...
                        <?php while ($row = mysqli_fetch_array($result)) {
                            ...
                            <tr <?php echo $style;?>>
                                ...
                                <td> <?php  echo htmlspecialchars_decode($row['vchCareerName'],ENT_NOQUOTES);?> </td>  
                                 ...
                                 <td> <?php  echo htmlspecialchars_decode($row['vchTickerName'],ENT_NOQUOTES);?> </td> 
                                 <td> <?php  echo htmlspecialchars_decode($row['vchExternalLink'],ENT_NOQUOTES);?> </td> 
                                <td width="100"><?php
