      ...
      <div class="loginBox">
        <div class="panel panel-login" style="margin-top:50px;">
          <div class="panel-heading text-center">
            <h4 id="loginTitle">
                 <span id="CompanyName">OSDA</span>
<!--              <h2><span id="headerText">BHUBANESWAR</span></h2>-->
            </h4>
        ...
        <div class="space"></div>
        <div style="padding-bottom: 10px;"> <a href="javascript:void(0);" onClick="window.location.href='<?php echo APP_URL;?>home'" class="btn btn-info"> <i class="ace-icon fa fa-home"></i> Home </a> </div>
      </div>
        </div>
