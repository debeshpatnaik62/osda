...
/* ================================================
  ...
  ================================================== */
    require("viewEmpDirectoryInner.php");
?>

<script language="javascript">
    $(document).ready(function () {
        loadNavigation('View District Employment Directory');
        pageHeader      = "View District Employment Directory";
    ...
    <div class="row">
        <div class="col-xs-12">
            ...
            <?php  if($adminConsole_Privilege==0|| $adminConsole_Privilege==1 ||$intPermission!=2) { ?>
              ...
              <a href="<?php echo APP_URL ?>archiveEmpDirectory/<?php echo $glId; ?>/<?php echo $plId; ?>" class="btn btn-info">Archive</a> 
            </div>
            ...
            <div class="searchTable">
              <div class="form-group">
                  ...
                  <label class="col-sm-1 control-label no-padding-right" for="ddlType">Type</label>
                    <div class="col-sm-2"> 
                        <span class="colon">:</span>
                   ...
                   <label class="col-sm-1 control-label no-padding-right" for="txtEmployeeName"> Employee Name</label>
          ...
          <div class="legandBox">			
                <span class="greenLegend">&nbsp;</span>Published Employee(s) &nbsp;			
                <span class="yellowLegend">&nbsp;</span> Unpublished Employee(s) &nbsp;
            </div>
             <div id="viewTable">
