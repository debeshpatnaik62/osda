...
//=================== View skill records ================================
        if ($isPaging==0) {
            $result   = $objResult->manageResult('PGQ',$intRecno,$distId,$skillId,'','','','','','',$marks,$level,0,$qualify,0,$intPgSize,'','',$gender,$regdType);
        } else {
            $intPgno            = 1;
            $intRecno           = 0;
            $result   = $objResult->manageResult('VQ',0,$distId,$skillId,'','','','','','',$marks,$level,0,$qualify,0,0,'','',$gender,$regdType);
        }

        $totalResult            = $objResult->manageResult('CQ',0,$distId,$skillId,'','','','','','',$marks,$level,0,$qualify,0,0,'','',$gender,$regdType);
