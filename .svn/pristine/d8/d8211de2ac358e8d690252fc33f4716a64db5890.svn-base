<?php
 /* ================================================
	  File Name         	  : viewSkillCompetitionDetails.php
  ...
  ================================================== */
    include_once('viewSkillCompetitionDetailsInner.php');
?>
    ...
    <div class="row">
        <div class="col-xs-12">
            ...
            <div class="top_tab_container">
                ...
                <a href="javascript:void(0);" class="btn btn-info active">Portal</a>
                <!-- <a href="<?php echo APP_URL; ?>viewSkillWSIDDetails/<?php echo $glId; ?>/<?php echo $plId; ?>" class="btn btn-info">WSC</a>  -->          
            ...
            <div class="searchTable" >
                ...
                <div class="form-group">                   
                   ...
                   <!-- <label class="col-sm-2 control-label no-padding-right" for="selQualify">Result </label>
                    ...
                    <!-- <label class="col-sm-1 control-label no-padding-right" for="selUpdateSkill">Updated Skill</label>
                    <div class="col-sm-2"> <span class="colon">:</span> 
                        <select class="form-control" name="selUpdateSkill" id="selUpdateSkill" >
                                <option value="0">--All--</option>
