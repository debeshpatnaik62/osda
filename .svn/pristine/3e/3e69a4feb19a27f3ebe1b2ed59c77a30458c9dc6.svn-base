<?php
    ...
    $explPriv       = $objTraining->checkPrivilege($userId, $glId, $plId, $pageName, 'V');
...
/*
    ...
    if(isset($_REQUEST['hdn_qs'])&& $_REQUEST['hdn_qs']!='' )
    {
        ...
        $outMsg = $objTraining->deleteTraining($qs,$ids);
    }
        ...
        if($isPaging==0){
            ...
            $result     = $objTraining->manageTraining('PG', $arrConditions); 
    }
    ...
    else
    {
            ...
            $result                 = $objTraining->manageTraining('V',$arrConditions);
          //  print_r($result);exit;
    }
           $intPgSize                   = 10;

       $totalResult                 = $objTraining->manageTraining('V',$arrConditions);
