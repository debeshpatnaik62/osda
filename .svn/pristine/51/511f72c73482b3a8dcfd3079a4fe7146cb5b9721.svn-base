...
<script language="javascript">
    $(document).ready(function () {
      //pageHeader = "Bulk Update data";
                strFirstLink = "Bulk Data";
                strLastLink = "Bulk Data";
        loadNavigation('Add Bulk SAP Data');
        indicate = 'yes';    
...
{
    print_r($excel_data); ?>
   <input type="hidden" id="hdnRegistrationRow" name="hdnRegistrationRow" value='<?php echo $arrRow; ?>'/>
     <div class="col-sm-12">
...
{ ?>
    ...
    <div style="text-align: right">
      <a class="btn btn-success" download href="<?php echo APP_URL ?>uploadDocuments/bulk/Registration_details.xls">Download Excel xls Format</a>
    </div>
    <hr>
