<?php
    /* ================================================
    File Name         	: archiveNewsInner.php
	...
	if(isset($_REQUEST['hdn_qs'])&& $_REQUEST['hdn_qs']!='' )
	{
		...
		$outMsg	= $objNews->deleteNews($qs,$ids);
         ...
         if($isPaging==0)	
                   $result		= $objNews->manageNews('PG',$intRecno,$newsCat,$strHeadlineE,'','', '0000-00-00 00:00:00','0000-00-00 00:00:00','','',0,1,0,$strStartDt,$strEndDate,'','','','','');

               else
               {
                   $intPgno	= 1;
                   $intRecno	= 0;
                   $result                 = $objNews->manageNews('V',0,$newsCat,$strHeadlineE,'','', '0000-00-00 00:00:00','0000-00-00 00:00:00','','',0,1,0,$strStartDt,$strEndDate,'','','','','');
               }
              $totalResult                 = $objNews->manageNews('V',0,$newsCat,$strHeadlineE,'','', '0000-00-00 00:00:00','0000-00-00 00:00:00','','',0,1,0,$strStartDt,$strEndDate,'','','','','');
