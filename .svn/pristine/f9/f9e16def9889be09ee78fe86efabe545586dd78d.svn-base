<?php
    /* ================================================
    File Name         	: archieveGalleryInner.php
	...
	if(isset($_REQUEST['hdn_qs'])&& $_REQUEST['hdn_qs']!='' )
	{
        ...
        if($isPaging==0)	
            $result		= $objGallery->manageGallery('PG',$intRecno,$intCategory,$intCattype,0,'','','','','','','',0,1,0,'');              
	else
	{
            $intPgno	= 1;
            $intRecno	= 0;
            $result                 = $objGallery->manageGallery('V',0,$intCategory,$intCattype,0,'','','','','','','',0,1,0,'');      
	}
       $totalResult                 = $objGallery->manageGallery('V',0,$intCategory,$intCattype,0,'','','','','','','',0,1,0,'');      
