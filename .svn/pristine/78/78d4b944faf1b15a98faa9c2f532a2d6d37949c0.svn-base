...
/* * ****Class to manage Skill News ********************
'By                     : Rahul Kumar Saw'
'On                     : 25-July-2022        '
' Procedure Used        : USP_SKILL_NEWS_DETAILS       '
* ************************************************** */

class clsSkillNews extends Model {

// Function To Manage News By::Rahul Kumar Saw   :: On:: 25-May-2015
    public function manageSkillNews($action, $newsId, $newsCat,$headLineE, $headLineH, $image, $expdate, $newsDate, $descriptionE, $descriptionH, $pubStatus,$archiveStatus ,$createdBy,$startDate,$endDate,$txtSource,$txtSourcenameE,$txtSourcenameO,$txtSnippet,$txtSnippetO) {
       ...
       // $headLineH          = addslashes($headLineH);
        ...
        $newsSql            = "CALL USP_SKILL_NEWS_DETAILS('$action', $newsId, $newsCat,'$headLineE', '$headLineH', '$image', '$expdate', '$newsDate', '$descriptionE', '$descriptionH', $pubStatus,$archiveStatus, $createdBy,'$startDate','$endDate','$txtSource','$txtSourcenameE','$txtSourcenameO','$txtSnippet','$txtSnippetO',@OUT);";
 //echo $newsSql;             
...
// Function To Add Upadate Page By::Rahul Kumar Saw   :: On:: 18-Nov-2015
    public function addUpdateSkillNews($newId) { 
      ...
      if ($newSessionId == $hdnPrevSessionId) {    
        ...
        $errSourcenameO          = Model::isSpclChar($_POST['txtSourceNameO']);
        ...
        $errSourceUrl           = Model::isSpclChar($_POST['txtSource']);
        ...
        else if($errHeadlineE>0 || $errSourcename>0 || $errHeadlineH >0 || $errSourcenameO >0 || $errSourceUrl >0)
        {
            $errFlag		= 1;
            $flag               = 1;
        ...
        if($errFlag==0 && $userId>0){
            ...
            $dupResult = $this->manageSkillNews('CD', $newsId,$newsCat,$txtHeadlineE,'','', '0000-00-00','0000-00-00','','',0,0,$userId,'0000-00-00','0000-00-00','','','','','');
              ...
              if ($dupResult) {
                ...
                if ($numRows > 0) {
                    ...
                    $result = $this->manageSkillNews($action, $newsId,$newsCat, $txtHeadlineE,$txtHeadlineH,$fileDocument, $expDate,$newsDate,$txtDetailsE,$txtDetailsH, 0,0 ,$userId,'0000-00-00','0000-00-00',$txtSource,$txtSourceNameE,$txtSourceNameO,'','');
                    if($result)
                    {
        ...
        $arrResult = array('strSourceNameE' => $strSourceNameE,'strSourceNameO' => $strSourceNameO,'strNewsDate' => $strNewsDate,'msg' => $outMsg, 'flag' => $errFlag, 'strHeadLineE' => $strHeadLineE,'strHeadLineH' => $strHeadLineH,  'strFileName' => $strFileName, 'strExpDate' => $strExpDate, 'strDetailE' => $strDetailE,'intCategoryId'=>$intNewsCat,'strDetailH'=>$strDetailH);
        return $arrResult;
    }

// Function To read News  By::Rahul Kumar Saw  :: On:: 18-Nov-2015
    public function readSkillNews($id) {

        $result = $this->manageSkillNews('R',$id,0,'','','', '0000-00-00','0000-00-00','','',0,0,0,'0000-00-00','0000-00-00','','','','','');
        ...
        $arrResult = array('strSourceNameE' => $strSourceNameE,'strSourceNameO' => $strSourceNameO,'strSource'=>$strSource,'stmCreatedOn'=>$stmCreatedOn,'intCategoryId'=>$intCategoryId,'strHeadLineH' => $strHeadLineH,'strDetailH' => $strDetailH,'strNewsDate' => $strNewsDate,'strHeadLineE' => $strHeadLineE, 'strFileName' => $strFileName, 'strExpDate' => $strExpDate, 'strDetailE' => htmlspecialchars_decode($strDetailE,ENT_NOQUOTES));
        return $arrResult;
    }
	// Function To read News  By::Rahul Kumar Saw   :: On:: 18-Nov-2015
    public function updateExpary() {
        ...
        if ($newSessionId == $hdnPrevSessionId) {  
                ...
                $result = $this->manageSkillNews('UE', $id, '','','', $txtExparyDate,'0000-00-00','','', '','',0,0,0,'0000-00-00','0000-00-00','','','','','');
                if ($result)
...
// Function To Delete News  By::Rahul Kumar Saw   :: On:: 18-Nov-2015
    public function deleteSkillNews($action, $ids) {
        ...
        if ($newSessionId == $hdnPrevSessionId) {  
                ...
                foreach ($explIds as $indIds) {
                    ...
                    $result = $this->manageSkillNews($action,$explIds[$ctr],0,'','','', '0000-00-00','0000-00-00','','',0,0,0,'0000-00-00','0000-00-00','','','','','');                   
