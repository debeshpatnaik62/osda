            ...
            <div class="searchTable">
			  ...
			  <div class="col-sm-2">
				<input class="btn btn-success" name="btnSearch" type="submit" value="Show"/>
                 <input class="btn btn-danger" name="btnClear" type="button" value="Clear" onclick="window.location.href = '<?php echo APP_URL; ?>archievePage/<?php echo $glId . '/' . $plId; ?>' ">
			  </div>
                </div>
            </div>
            <div id="viewTable">
                   ...
                   <table class="table  table-bordered table-hover">
                        ...
                        <tbody>
                            <?php while ($row = mysqli_fetch_array($result)) {
                                ...
                                <img src="<?php echo APP_URL;?>uploadDocuments/featuredImage/<?php echo $row['vchFeaturedImage'];?>" alt="<?php echo $row['vchTitle'];?>" width="130" height="50" />
                                <?php }else echo '&nbsp;';?></td>
