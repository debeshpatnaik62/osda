<?php
/* ================================================
  File Name       : viewPanelVenue.php
  Description		  : This is used for view the panel wise venue details.
  ...
  ================================================== */
    require("viewPanelVenueInner.php");
?>

<script language="javascript">
    $(document).ready(function () {
        loadNavigation('View Panel Venue');
        pageHeader      = "View Panel Venue";
        strFirstLink    = "Manage Skill Competition";
        strLastLink     = "View Panel Venue";
    ...
    <div class="row">
        <div class="col-xs-12">
            ...
            <div class="top_tab_container">
              ...
              <a href="<?php echo APP_URL ?>addPanelVenue/<?php echo $glId; ?>/<?php echo $plId; ?>" class="btn btn-info">Add</a> 
            ...
            <div class="searchTable">
              <div class="form-group">
                  <label class="col-sm-1 control-label no-padding-right" for="ddlDistrict">District</label>
                   ...
                   <label class="col-sm-1 control-label no-padding-right" for="txtEmployeeName"> Venue Name</label>
                        ...
                        <?php while ($row = $result->fetch_array()) {
                         ...
                         ?>
                            <tr <?php echo $style;?>>
                                ...
                                <td align="center" valign="middle" class="noPrint"><a href="<?php echo APP_URL?>addPanelVenue/<?php echo $glId; ?>/<?php echo $plId; ?>/<?php echo $row['intVenueId'] ?>" data-rel="tooltip" title="" data-original-title="Edit" class="btn btn-xs btn-info"> <i class="ace-icon fa fa-pencil bigger-120"></i> </a></td>
                            </tr>
                        <?php } ?>
                         </tbody>
                    </table>
