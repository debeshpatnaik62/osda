<?php
 /* ================================================
	  File Name         	  : share-your-story.php
	  Description	          : This is used for view Share Your Story.
	 ...
	 *       
	  Style sheet             : 
	  Javscript Functions     : 
	  includes                : share-your_storyInner.php
  ================================================== */
    include_once('share-your-storyInner.php');
?>
...
<script language="javascript">
    $(document).ready(function () {
        loadNavigation('View Share Story');
        pageHeader   = "View Share Story";
        strFirstLink = "Manage Institutions";
        strLastLink  = "Share Your Story";
    ...
    <div class="row">
        <div class="col-xs-12">
            ...
            <div class="top_tab_container">
                ...
                <a href="javascript:void(0);" class="btn btn-info active">Shared Story</a>           
            ...
            <div class="searchTable" >
                <div class="form-group">
                    ...
                    <div class="col-sm-2">
                        ...
                        <input class="btn btn-danger" name="btnClear" type="button" value="Clear" onclick="window.location.href ='<?php echo APP_URL; ?>share-your-story/<?php echo $glId . '/' . $plId; ?>' ">
                    </div>
                </div>
            </div>            
            <div id="viewTable">
                        ...
                        <tbody>
                           ...
                           while ($row = $result->fetch_array()) {
                                ...
                                <tr>
                                    <td class="noPrint">
                                        <label class="position-relative">
                                            <input type="checkbox" class="ace chkItem" value="<?php echo $row['INT_STORY_ID']; ?>"><span class="lbl"></span></label>
                                    </td>
                                    <td><?php echo $ctr; ?></td>
                                    ...
                                    <td><?php echo $row['VCH_PHONE']; ?></td>
                                     ...
                                     <td align="center">
                                        <?php if($row['VCH_ATTACHMENT']!=''){ ?>
                                        <a href="<?php echo APP_URL ?>uploadDocuments/story/<?php echo $row['VCH_ATTACHMENT'];?>" target="_blank"><img src="<?php echo APP_URL;?>img/pdf.png" alt="" align="absmiddle"  /></a>
                                        <?php }else echo '&nbsp;';?>
                                    </td>  

<!--                                    <td><?php //echo ucfirst(htmlspecialchars_decode($row['VCH_MESSAGE'], ENT_QUOTES)); ?>
                                    </td>-->
                                    <td>
                                    <?php if ($row['VCH_MESSAGE'] != '') { ?>
                                            <a href="#myModal<?php echo $row['INT_STORY_ID']; ?>" role="button" data-toggle="modal">
                                            <?php $strMessage =  htmlspecialchars_decode($row['VCH_MESSAGE'], ENT_QUOTES); 
                                              echo $shortmsg = $objStory->wardWrap($strMessage, 50);
                                            ?></a>

                                            <div class="modal fade" id="myModal<?php echo $row['INT_STORY_ID']; ?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
            ...
            <?php echo htmlspecialchars_decode($row['VCH_MESSAGE'], ENT_QUOTES); ?>
                                                        </div>
                                        ...
                                        <?php } else { ?>
                                            <?php echo htmlspecialchars_decode($row['VCH_MESSAGE'], ENT_NOQUOTES); ?>
        <?php } ?>   
                            </td>        
