  ...
  //print_r($_SESSION);exit;
    ...
    if($isPaging==0 && $_REQUEST['hdn_PageNo']=='' && $_REQUEST['ID']>0)
    {
        ...
        if($isPaging==0){
            ...
            $result     = $objIns->manageSkillInsRegd('PGA', $arrConditions); 
        }
        ...
        else
        {
                ...
                $intRecno   = 0;
                //$arrConditions=array('reportID'=>$intRecno ,'pageCount'=>20,'userId'=>$userId);
                $result                 = $objIns->manageSkillInsRegd('VA',$arrConditions);
        }
           $intPgSize                   = 20;

       $totalResult                 = $objIns->manageSkillInsRegd('VA',$arrConditions);
