...
/* ================================================
  ...
  ================================================== */
    require("addSAMSInstituteInner.php");
    ...
    <div class="row">
        <div class="col-xs-12"> 
            ...
            <div class="top_tab_container"> 
               ...
               <a href="<?php echo APP_URL; ?>addSAMSPOLInstitute/<?php echo $glId; ?>/<?php echo $plId; ?>" class="btn btn-info">SAMS Politechnic Institute Tag</a>
        ...
        <table class="table table-striped table-bordered table-hover">
            ...
            <tr>
              ...
              <th><label>SAMS ITI Institute</label>
                <span class="red">*</span> 
              </th>
              <th ><label>OSDA ITI Institute</label>
                <span class="red">*</span> 
              </th>          
            </tr>
            </thead>
