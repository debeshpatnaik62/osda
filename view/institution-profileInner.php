  ...
  //echo $strCourseAlias.'gg '.$intDistrict;
        ...
        if(isset($_REQUEST['btnSearch']))
	{
        ...
        try{
                ...
                if($isPaging==0)	
                    $result                     = $objInstitute->manageInstitute('PPG',$intRecno,$intDistrict,$strInstitute,'',0,0,'','','','','','','','','','',$intCourseId,0,0,$intPgSize,'','',1,'',0,0,0,'');
                else                                    
                {
                    $intPgno                = 1;
                    $intRecno               = 0;
                    $result                 = $objInstitute->manageInstitute('VP',0,$intDistrict,$strInstitute,'',0,0,'','','','','','','','','','',$intCourseId,0,0,0,'','',1,'',0,0,0,'');
                }
                $totalResult                 = $objInstitute->manageInstitute('CTP',0,$intDistrict,$strInstitute,'',0,0,'','','','','','','','','','',$intCourseId,0,0,0,'','',1,'',0,0,0,'');
         ...
         $strPageTitle           = ($_SESSION['lang']=='O')?'&#2858;&#2893;&#2864;&#2891;&#2859;&#2878;&#2823;&#2866; &#2860;&#2879;&#2860;&#2864;&#2851;&#2880;':'Institution-profile';
