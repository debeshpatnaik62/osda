        ...
        <section class="container contarea">
            ...
            <div class="col-md-12 col-sm-12">
                <div class="form-group row">
                    <h3 class="screenreader osda--heading <?php echo $strLangCls; ?>" tabindex="13">
                        <?php echo $strSkillInfolbl; ?>
                    </h3>
                </div>
                ...
                <div class="form-horizontal skillCompeteForm">
                    <!--
                                        <div class="highlight-text">
                                            <div class="form-group row">
                                                <label class="screenreader <?php echo $strLangCls; ?>" tabindex="14">
                    <?php echo 'Select trade of your competition out of 45'; ?><span class="required">*</span>
                                                </label>
...
<?php echo $strExamcenter; ?>
                ...
                <div class="clearfix"></div>
                <div class="form-group row">
                    <h3 class="screenreader osda--heading <?php echo $strLangCls; ?>" tabindex="80">
...
<?php echo $strProfilepiclbl; ?>
                                            ...
                                            <label class="uploadImg">
                                                <input type="file" name="fileUploadPhoto" id="fileUploadPhoto"  onchange="uploadFileToTemp('skillCopmetition_Profile', this.id, 'hdnProfilePic', 'jpg,jpeg,gif,png', 'loaderProfilePic', '1024', 1, 2, 'dispProfileimg', 1, 'spnProfilePic');"/>
                                                <img src="<?php echo SITE_URL; ?>images/demo-profile.png" id="dispProfileimg" width="100" height="100"/>

                                                <input type="hidden" class="hdnProfilePic" id="hdnProfilePic" name="hdnProfilePic" value="" />
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-6">
                                            ...
                                            <span class="required">*</span>
                                            <input type="text" class="form-control" id="txtAadharNo" name="txtAadharNo" value="<?php echo $selIdProof; ?>" maxlength="12" on>
...
<?php echo $strAadharUploadLevel; ?>
                                            ...
                                            <span class="required">*</span>
                                            <input type="file" class="form-control" id="fileDocument" name="fileDocument" onchange="uploadFileToTemp('skillcomp_idproof', this.id, 'hdnIdProofPic', 'jpg,jpeg,pdf', 'loaderIdProof', '2048', 1, 2, '', 1, 'spnIdProof');">
                                            <input type="hidden" class="hdnIdProofPic" id="hdnIdProofPic" name="hdnIdProofPic" value="" />
...
<?php echo $strAcademiclbl; ?>
                                            ...
                                            <span class="required">*</span>
                                            <input type="text" class="form-control" id="txtAcademicInstitute" name="txtAcademicInstitute" value="<?php echo $txtWorkPlace; ?>"  maxlength="100" >                              
...
<?php echo $strDoblbl; ?>
                                        ...
                                        <span class="required">*</span>
                                        <div class='input-group date'>  
                                            <input type="text" class="form-control datepicker" data-date-format="dd-mm-yyyy" id="txtDobpop" name="txtDobpop" value="<?php echo ($txtDobpop != '') ? date('d-m-Y', strtotime($txtDobpop)) : ''; ?>"  maxlength="15" >                                                                   <span class="input-group-addon">
                                                <span class="input-group-addon">  <span class="glyphicon glyphicon-calendar"></span></span>
                                            </span>
                                        </div>
                                    </div>
...
<?php echo $strProfilepiclbl; ?>
                                        ...
                                        <label class="uploadImg">
                                            ...
                                            <input type="file" name="fileUploadPhoto1" id="fileUploadPhoto1"  onchange="uploadFileToTemp('skillCopmetition_Profile', this.id, 'hdnProfilePic1', 'jpg,jpeg,gif,png', 'loaderProfilePic', '1024', 1, 2, 'dispProfileimg1', 1, 'spnProfilePic1');"/>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-6">
                                        ...
                                        <span class="required">*</span>
                                        <input type="text" class="form-control" id="txtAadharNopop" name="txtAadharNopop" value="<?php echo $selIdProofpop; ?>" onKeyPress="return isNumberKey(event);" maxlength="12" on>
...
<?php echo $strAcademiclbl; ?>
                                        ...
                                        <span class="required">*</span>
                                        <input type="text" class="form-control" id="txtAcademicInstitutepop" name="txtAcademicInstitutepop" value="<?php echo $txtWorkPlacepop; ?>"  maxlength="100" >
...
<!--                                                 <select class="form-control" name="txtAcademicInstitute" id="txtAcademicInstitute" >
                        ...
                        <div class="orm-group row text-center captcha_form ">
                            ...
                            <input type="hidden" name="hdnFromdate" id="hdnFromdate" value="1995-01-01" maxlength="10">
                            <input type="hidden" name="hdnTodate" id="hdnTodate" value="1998-01-01" maxlength="10">
            ...
            <!--
<input type="hidden" name="hdnFromdate" id="hdnFromdate" value="1997-01-01" maxlength="10">
<input type="hidden" name="hdnTodate" id="hdnTodate" value="2002-01-01" maxlength="10">
            -->
            </div>
        </section>
...
<?php } ?>
                    ...
                    <?php } ?>
                                    ...
                                    function validateSkill() {
                                        ...
                                        if (!blankCheck('txtLastName', 'Please enter Last Name'))
                                            return false;
                                        ...
                                        if (txtDob != '') {
                                            ...
                                            if ($('#chkSkillset_28,#chkSkillset_21').is(":checked")) {

                                                var firstDate = new Date('1995-01-01');
                                                var datedisplay = '01/01/1995';
                                            } else {
                                                var firstDate = new Date('1998-01-01');
                                                var datedisplay = '01/01/1998';
                                            }
                                            var secondDate = new Date('2005-01-01');

                                            if (dobDate > secondDate) {
                                                viewAlert("Applicant should be born between " + datedisplay + " and 01/01/2005", 'txtDob', '');
                                                return false;
                                            } else if (dobDate < firstDate) {
                                                viewAlert("Applicant should be born after " + datedisplay + " and 01/01/2005", 'txtDob', '');
                                                return false;
                                            }
                                        ...
                                        if (!blankCheck('fileDocument', 'Please upload the document of identity proof '))
                                            return false;

                                        if (!selectDropdown('selQualification', 'Select Education Qualification'))
                                            return false;

                                       /* var instituteId = $('#hidInsId').val();
                                        if (!(instituteId > 0)) {
                                            viewAlert('Please Select Name of Academic Institution');
                                        }*/
                                        if (!blankCheck('txtAcademicInstitute', 'Please Enter Name of your Academic Institution'))
                                            return false;


                                        if ($('#chkSkillset_28,#chkSkillset_26,#chkSkillset_12').is(":checked")) {
                                            ...
                                            if (!maxLength('txtFirstNamepop', 30, 'Second applicant First Name'))
                                                return false;
                                            if (!blankCheck('txtLastNamepop', 'Please enter Last Name of Second Applicant'))
                                                return false;
                                            ...
                                            if (txtDobpop != '') {
                                                ...
                                                if (dobDatepop > secondDate) {
                                                    viewAlert("Applicant should be born between " + datedisplay + " and 01/01/2005", 'txtDobpop', '');
                                                    return false;
                                                } else if (dobDatepop < firstDate) {
                                                    viewAlert("Applicant should be born after " + datedisplay + " and 01/01/2005", 'txtDobpop', '');
                                                    return false;
                                                }
                                    ...
                                    function setQualifyId(ctrlId,txtFieldId,hdnInstituteId,$dataBindCtrlId,val){
                                           $('#'+ctrlId).val(val);
                                           $('#'+txtFieldId).val('');
                                           $('#'+hdnInstituteId).val('');
                                           var QualifyId=val;
                                           fillSkillInstitutes($dataBindCtrlId, this.value, 0, 'hidInsId', txtFieldId,QualifyId);
                                    }
