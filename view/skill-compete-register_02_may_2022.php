        ...
        <section class="container contarea">
            ...
            <div class="row" >
                <div class="col-md-12 col-sm-12">
                    ...
                    <img src="<?php echo SITE_URL; ?>images/registerbanner.jpg" alt="Register for Odisha Skills Competition - Odisha 2019" width="100%"/>
                </div>


                <div class="col-md-12 col-sm-12 mt-3">
                    <div class="star"> <span>*</span><?php echo $strIndicatelbl; ?></div> 
                        ...
                        <div class="registerlist">
                            <div class="row">
                                ...
                                while ($skillRow = $skillResults->fetch_array()) {
                                    ...
                                    $chkAry = array(28,33,22,23,47,48,50,51,52);
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-6">
                                            ...
                                            <label class="uploadImg">
                                                <input type="file" name="fileUploadPhoto" id="fileUploadPhoto"  onchange="uploadFileToTemp('skillCopmetition_Profile', this.id, 'hdnProfilePic', 'jpg,jpeg,gif,png', 'loaderProfilePic', '1024', 1, 2, 'dispProfileimg', 1, 'spnProfilePic');" value="<?php echo $profilePhoto;?>"/>
                    ...
                    <?php } ?>
                                    ...
                                    function validateSkill() {
                                        ...
                                        if (txtDob != '') {
                                            ...
                                            if ($('#chkSkillset_28,#chkSkillset_33,#chkSkillset_22,#chkSkillset_23,#chkSkillset_47,#chkSkillset_48,#chkSkillset_50,#chkSkillset_51,#chkSkillset_52').is(":checked")) {

                                                var firstDate = new Date('1996-01-01');
                                                var datedisplay = '01/01/1996';
                                            } else {
