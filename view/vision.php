        ...
        <div class="col-12">
             <div class="philosophy--banner">
              ...
              while($row=$totalResult->fetch_array()){
                 ...
                 $strTagline =  ($_SESSION['lang']=='O' &&  $row['vchTaglineO']!='')?urldecode($row['vchTaglineO']):htmlspecialchars_decode($row['vchTagline'], ENT_QUOTES); 
                ...
                ?>
                        <div class="item">
                            <img src="<?php echo $strImage;?>" alt="Vision" class="img-fluid">
                            <!-- <div class="overlay__section">
                                <span class="overlay__tag <?php echo $odiaClass;?>"><i class="fa fa-book"></i> <?php echo $ourVisonlbl;?></span>
                                <!-- <span class="overlay__text <?php echo $descClass;?>"><?php echo $strTagline;?></span>
                            </div>  -->
                        </div>
                    <?php $ctr++;}?>     
                    </div>
             ...
             <div class="page__content <?php echo $descClass;?>">
