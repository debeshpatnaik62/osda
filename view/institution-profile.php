                ...
                <div class="row">
                    <div class="col-sm-8">
                        <h2 class="text-center screenreader <?php echo $strLangCls; ?>"><?php echo $strOdishamaplbl; ?>
                            <span class="inspagelabelno screenreader"><?php echo $strInstCountinfo1; ?> <span class="<?php echo $strNumLangCls; ?>"><?php echo $intTotalRec; ?></span><?php echo $strInstCountinfo2; ?></span>
                        </h2>
                        <div class="mapBox">
