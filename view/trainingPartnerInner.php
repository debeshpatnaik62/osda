...
==================================================*/
    ...
    $intinstAlias     = (isset($_POST['hdnDdlPiaid']))?htmlspecialchars(trim($_POST['hdnDdlPiaid']), ENT_QUOTES):'';
  ...
  //echo $strCourseAlias.'gg '.$intDistrict;
        ...
        if(isset($_REQUEST['btnSearch']))
	{
        ...
        try{
                $mapresult		= $objDist->manageDistrict('GMP',$intCourseId,'','','','',3,0,0);
                $mapcount               = $mapresult->num_rows;
                
                /************view listing for mobile*********/
                if($isPaging==0)	
                    $result                 = $objInstitute->manageInstitute('PGT',$intRecno,$intDistrict,$strInstitute,'',0,0,'','','','','','','','','','',$intCourseId,0,0,$intPgSize,$intinstAlias,'',3,'',0,0,0,'');
                else                                    
                {
                    $intPgno                = 1;
                    $intRecno               = 0;
                    $result                 = $objInstitute->manageInstitute('VPT',0,$intDistrict,$strInstitute,'',0,0,'','','','','','','','','','',$intCourseId,0,0,0,$intinstAlias,'',3,'',0,0,0,'');
                }
                $totalResult                 = $objInstitute->manageInstitute('CTT',0,$intDistrict,$strInstitute,'',0,0,'','','','','','','','','','',$intCourseId,0,0,0,$intinstAlias,'',3,'',0,0,0,'');
        ...
        $strPageTitle           = ($_SESSION['lang']=='O')?'&#2852;&#2878;&#2866;&#2879;&#2862; &#2837;&#2887;&#2856;&#2893;&#2854;&#2893;&#2864;':'Training Centres';

         $strPageTtlcls            = ($strPageTtlcls=='')?$strcls:$strPageTtlcls;
         $strGlPageTitle           = ($_SESSION['lang']=='O' && $strGlPageTitle!='')?'&#2821;&#2856;&#2881;&#2871;&#2893;&#2848;&#2878;&#2856;':'Institute';
