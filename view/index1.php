<?php //include('view/indexInner.php');?>
<!doctype html>
<html lang="en">
...
.institute {margin-top: -27px;}		
}
	
@media (max-width: 425px){
.institute {margin-top: -32px;}	
}
	
@media (max-width: 380px){
.institute {margin-top: -76px;}	
}	
...
<div class="loader-wrapper">
	<div class="loadercont"> <img src="images/logoload.png" alt="Odisha Skill Development Authority logo"/>
			...
			<div id="introCarousel" class="carousel  slide carousel-fade" data-ride="carousel">
				...
				<div class="carousel-inner" role="listbox">
					...
					while ( $bannerRow = $bannerResult->fetch_array() ) {
						...
						$caption = ( $_SESSION[ 'lang' ] == 'O' && $bannerRow[ 'vchBcNmOdia' ] != '' ) ? htmlspecialchars_decode( $bannerRow[ 'vchBcNmOdia' ], ENT_QUOTES ) : $captionE;
											...
											<div class="philosophy card">
												...
												<div class="philosophycont">
													...
													<p class="<?php echo $odiaClass; ?>">
														<?php echo $objNews->wardWrap(strip_tags($strTagline), $tagLineCount); ?>
													</p>
		...
		<div class="col-md-12 pdl0 pdr0 nanoimg">
			<div class="container">
				<div class="unicornsec <?php echo $odiaClass;?>">
					...
					<p><?php echo $home42; ?></p>
					<a href="<?php echo SITE_URL; ?>nano-unicorn" class="unicornbtn hvr-sweep-to-right"><?php echo $strKnwMorelbl; ?></a> </div>
			</div>
		</div>
	</div>
	<!--End:: nano unicorn-->
					...
					<div class="col-12 col-sm-12 col-lg-4 d-flex">
						<div class="card">
							...
							<div class="card-body <?php echo $odiaClass;?>">
								...
								<a href="<?php echo SITE_URL; ?>contact-us/student" class="purplebtn hvr-grow">
									<?php echo $strKnwMorelbl; ?><i class="fa fa-chevron-right"></i> </a>
							</div>
						</div>
					</div>
					<div class="col-12 col-sm-12 col-lg-4 d-flex">
						<div class="card">
							...
							<div class="card-body <?php echo $odiaClass;?>">
								...
								<a href="<?php echo SITE_URL; ?>contact-us/training-partner " class="purplebtn hvr-grow">
									<?php echo $strKnwMorelbl; ?><i class="fa fa-chevron-right"></i> </a>
							</div>
						</div>
					</div>
					<div class="col-12 col-sm-12 col-lg-4 d-flex">
						<div class="card">
							...
							<div class="card-body <?php echo $odiaClass;?>">
								...
								<a href="<?php echo SITE_URL; ?>contact-us/employer" class="purplebtn hvr-grow">
									<?php echo $strKnwMorelbl; ?><i class="fa fa-chevron-right"></i> </a>
							</div>
						</div>
					</div>
			...
			<div class="skillcompetation">
				<div class="container">
					<div class="comptext <?php echo $odiaClass;?>">
						...
						<p><?php echo $home43; ?></p>
						<a href="<?php echo SITE_URL; ?>skill-competition" class="unicornbtn hvr-sweep-to-right"><?php echo $strKnwMorelbl; ?></a> </div>
					
					<div class="skill-logo"> 
					<a href="#"> <img src="images/IndiaSkills.png" alt="IndiaSkills"/> </a> 
					<a href="#"> <img src="images/WorldSkillKazan.png" alt="WorldSkillKazan"/> </a> 
					<a href="#"> <img src="images/WorldSkills.png" alt="WorldSkills"/> </a> 
