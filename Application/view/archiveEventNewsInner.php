<?php
	...
	if(isset($_REQUEST['hdn_qs'])&& $_REQUEST['hdn_qs']!='' )
	{
        ...
        if($isPaging==0){	
                 $result		= $objNews->manageEventNews('PG',$intRecno,$strHeadlineE,'','','0000-00-00','','',0,1,0,$strStartDt,$strEndDate);

               }else
               {
                   $intPgno	= 1;
                   $intRecno	= 0;
                   $result                 = $objNews->manageEventNews('V',0,$strHeadlineE,'','','0000-00-00','','',0,1,0,$strStartDt,$strEndDate);
               }
              $totalResult                 = $objNews->manageEventNews('V',0,$strHeadlineE,'','','0000-00-00','','',0,1,0,$strStartDt,$strEndDate);
