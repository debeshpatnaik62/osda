...
//============ Serach Function =====================//
 ...
 //============= Delete/Active/Inactive function =================
	if(isset($_REQUEST['hdn_qs'])&& $_REQUEST['hdn_qs']!='' )
	{
        ...
        try{
                if($isPaging==0)	
                    $result                 = $objCourse->viewCourse('PG',$intRecno,$intSectorId,$strCourseName,'','',0,0,'','',$intStatus,0,0,$intPgSize,'');
                else                                    
                {
                    $intPgno	= 1;
                    $intRecno	= 0;
                    $result                 = $objCourse->viewCourse('V',0,$intSectorId,$strCourseName,'','',0,0,'','',$intStatus,0,0,0,'');
                }
               $totalResult                 = $objCourse->viewCourse('CT',0,$intSectorId,$strCourseName,'','',0,0,'','',$intStatus,0,0,0,'');
