<?php
 /* ================================================
    ...
    Description           : This is used for enter mark for skill development result
   ...
   *       
    Style sheet             : 
    Javscript Functions     : 
    includes                : updateSkillMarksInner.php

   
  ================================================== */
    include_once('updateSkillMarksInner.php');
?>
    ...
    <div class="row">
        <div class="col-xs-12">
            ...
            <div class="top_tab_container">
                ...
                <a href="javascript:void(0);" class="btn btn-info active">Update Mark</a>
                           ...
                           while ($row = $result->fetch_array()) {
                            ...
                            if($row['intInstituteId']==1000)
                                ...
                                <tr>
                                    ...
                                    <td><input type="text" name="intMarks<?php echo $row['intId'];?>" id="intMarks<?php echo $row['intId'];?>" placeholder="Enter Mark" class="qMark" value="<?php echo ($row['intTestMark'])?$row['intTestMark']:'';?>" onkeypress="return isNumberKey(event);">
                                        </br>
                                        <?php if($row['marksUpdatedBY']!='Super Administrator' && $row['intTestMark']>0){?>
                                            Updated By :- <?php echo $row['marksUpdatedBY'];?>
                                        <?php } ?>
                                    </td>
