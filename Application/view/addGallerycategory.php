    ...
    <div class="page-content">
      ...
      <div class="row">
        <div class="col-xs-12">
          ...
          <a href="<?php echo APP_URL;?>viewGallerycategory/<?php echo $glId; ?>/<?php echo $plId; ?>" class="btn btn-info">View</a></div>
...
<!--               <input type="hidden" name="ddlType" value="" />-->
              <div class="form-group">
               ...
               <div class="form-group">
                ...
                <div class="col-sm-4">
                <span class="colon">:</span>
                <input type="text" id="txtCategory_O" name="txtCategory_O" maxlength="80" placeholder="" class="form-control odia" value="<?php echo $strCategoryO; ?>">
