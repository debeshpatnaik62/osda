<?php
    /* ================================================
    File Name         	  : viewSkillEvent.php
    Description		      : This is used for view Skill Event News.
    Devloped On           : 29-Dec-2021
    Devloped By           : Rahul Kumar Saw 
    Update History	      : <Updated by>		<Updated On>		<Remarks>

    Style sheet           : bootstrap.min.css, font-awesome.min.css, ace.min.css, custom.css
    Javscript Functions   : jquery.min.js, bootstrap.min.js, custom.js, loadcomponent.js
    includes		      : header.php, navigation.php, util.php, footer.php,viewSkillEventInner.php

    ==================================================*/
    require 'viewSkillEventInner.php';
?>
...
<script language="javascript">
	$(document).ready(function () {
		loadNavigation('View Skill Events');
                strFirstLink = "Manage Skill Competition";
                strLastLink  = "Skill Events";
    ...
    <div class="page-content">
        ...
        <div class="row">
            ...
            <div class="top_tab_container">
                <?php  if ($noAdd != '1') { ?>
                    <a href="<?php echo APP_URL?>addSkillEvent/<?php echo $glId; ?>/<?php echo $plId; ?>" class="btn btn-info">Add</a>
                <?php }?>
                ...
                <div class="legandBox">			
                    <span class="greenLegend">&nbsp;</span>Published Event&nbsp;			
                    <span class="yellowLegend">&nbsp;</span> Unpublished Event &nbsp;
                </div>
                <div id="viewTable">
              		...
              		<tbody>
                        <?php while ($row = mysqli_fetch_array($result)) {
                            ...
                            <tr <?php echo $style;?>>
                                ...
                                <td><?php echo $ctr; ?></td>
                                <td> 
                                    <?php echo htmlspecialchars_decode($row['vchHeadLineE'],ENT_NOQUOTES);?>
                                </td>  
                                <td class="odia">
                                    ...
                                    <?php if($row['vchImageFile']!='')
                                     {
                                         ...
                                         {
                                    ?>
                                            <img src="<?php echo APP_URL ?>uploadDocuments/event/<?php echo $row['vchImageFile'];?>" alt="<?php echo $row['vchHeadLineE']; ?>" width="150" height="80" />
                                    <?php 
                                         }
                                        else {
                                       ?>
                                           <img src="<?php echo APP_URL ?>uploadDocuments/event/<?php echo $row['vchImageFile'];?>" alt="" width="100" height="100" border="0" align="absmiddle"/>
                                ...
                                <td align="center" valign="middle" class="noPrint" style="<?php echo $editPriv; ?>"><a href="<?php echo APP_URL?>addSkillEvent/<?php echo $glId; ?>/<?php echo $plId; ?>/<?php echo $row['intEventId'] ?>" data-rel="tooltip" title="" data-original-title="Edit" class="btn btn-xs btn-info"> <i class="ace-icon fa fa-pencil bigger-120"></i> </a></td>
                            </tr>
                        <?php } ?>
                         </tbody>
                    </table>
