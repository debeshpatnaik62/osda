<?php
   ...
   //  $id                 = (isset($_REQUEST['ID']) && is_numeric($_REQUEST['ID']))?htmlspecialchars($_REQUEST['ID'],ENT_QUOTES):0;  
    ...
    $explPriv       = $objPartner->checkPrivilege($userId, $glId, $plId, $pageName, 'V');
	...
	if($isPaging==0 && $_REQUEST['hdn_PageNo']=='' && $_REQUEST['ID']>0)
	{
       ...
       try{
               ...
               if(isset($_REQUEST['hdn_qs'])&& $_REQUEST['hdn_qs']!='' )
               {
                       ...
                       $outMsg	= $objPartner->deleteSkillPartner($qs,$ids);
               }
               if($isPaging==0)	
                   $result		= $objPartner->manageSkillPartner('PG',$intRecno,$newsCat,$strHeadlineE,'','', '0000-00-00 00:00:00','0000-00-00 00:00:00','','',0,0,0,$strStartDt,$strEndDate,'','','');
                 //print_r($objPartner);exit;
                 //print_r($result);exit;
               ...
               else
               {
                   $intPgno	= 1;
                   $intRecno	= 0;
                   $result                 = $objPartner->manageSkillPartner('V',0,$newsCat,$strHeadlineE,'','', '0000-00-00 00:00:00','0000-00-00 00:00:00','','',0,0,0,$strStartDt,$strEndDate,'','','');
               }
              $totalResult                 = $objPartner->manageSkillPartner('V',0,$newsCat,$strHeadlineE,'','', '0000-00-00 00:00:00','0000-00-00 00:00:00','','',0,0,0,$strStartDt,$strEndDate,'','','');
