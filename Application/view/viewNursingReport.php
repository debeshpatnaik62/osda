<?php
    /* ================================================
    File Name         	  : viewHMReport.php
    Description		      : This is used for view Hotel Management Report.
    ...
    Style sheet           : 
    Javscript Functions   : 
    includes		  : util.php, viewHMReportInner.php

    ==================================================*/
    require 'viewNursingReportInner.php';
?>
<script src="<?php echo APP_URL; ?>js/validatorchklist.js"></script>
<script language="javascript">
	$(document).ready(function () {
            loadNavigation('Nursing College Report');
            pageHeader      = "Nursing College Report";
            strFirstLink    = "Manage Reports";
            strLastLink     = "Nursing College Report";
            downloadMe      = 'yes';
    ...
    <div class="page-content">
        ...
        <div class="row">
            ...
            <div class="top_tab_container">
                <a href="<?php echo APP_URL;?>viewITIReport/<?php echo $glId; ?>/<?php echo $plId; ?>" class="btn btn-info">ITIs <span class="badge badge-pill badge-danger"><strong><?php echo $itiCount;?></strong></span></a>
                ...
                <a href="<?php echo APP_URL;?>viewGraduateReport/<?php echo $glId; ?>/<?php echo $plId; ?>" class="btn btn-info">Graduation Colleges <span class="badge badge-light"><?php echo  $gradCount;?></span></a>
                <a href="<?php echo APP_URL;?>viewHMReport/<?php echo $glId; ?>/<?php echo $plId; ?>" class="btn btn-info">Hotel Management <span class="badge badge-danger"><?php echo  $hmCount;?></span></a>
                <a href="javascript:void(0);" class="btn btn-info active">Nursing Colleges <span class="badge badge-danger"><?php echo  $nurseCount;?></span></a>
 ...
 -->
                      ...
                      <div class="col-sm-2">
                        ...
                        <input class="btn btn-danger" name="btnClear" type="button" value="Clear" onclick="window.location.href ='<?php echo APP_URL; ?>viewNursingReport/<?php echo $glId . '/' . $plId; ?>' ">
                     </div>                
              </div>
            </div>
                <div id="viewTable">
                <?php if (mysqli_num_rows($result) > 0) {
              		...
              		<tbody>
                        <?php while ($row = mysqli_fetch_array($result)) {
                            ...
                            <tr>
                               ...
                               <td><?php echo $ctr; ?></td>
                                <td> <?php  echo htmlspecialchars_decode(rtrim($row['vchInstituteName']),ENT_QUOTES);?> </td>
                    ...
                    <input name="hdn_qualification" id="hdn_qualify" type="hidden" value="22"/>
                <?php } else { ?>
