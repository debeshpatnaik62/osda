<?php
    ...
    require 'approveInstituteInner.php';
?>
...
<script language="javascript">
	$(document).ready(function () {
		pageHeader = "Skill Development Program";
                ...
                strLastLink = "Approved Institute Details";
    ...
    <div class="page-content">
        ...
        <div class="row no-margin">
            ...
            <div class="top_tab_container">
                ...
                <a href="javascript:void(0);" class="btn btn-info active">View Institute Details</a>
                 </div>
                    ...
                    <table class="table  table-bordered table-hover">
                        <thead>
                            <tr>
                                ...
                                <th>Contact No.</th>   
                                <th>PAN Number</th>   
                                <th>Institute Regd No.</th>
                                <th>Institute Address</th>
                                <th>Total Tagged Program</th>
                                <th>Action</th> 
                            </tr>
                        </thead>
              		<tbody>
                        <?php while ($row = mysqli_fetch_array($result)) {
                            ...
                            <tr>
                                ...
                                <td><?php echo htmlspecialchars_decode($row['vchInsEmail'], ENT_QUOTES); ?></td>
                                <td><?php echo htmlspecialchars_decode($row['vchInsMobile'], ENT_QUOTES); ?></td>
                                ...
                                <td>
                                 <?php if ($row['totalProgram'] > 0) { ?>
                                            <a href="<?php echo APP_URL; ?>viewTaggedProgram/<?php echo $glId; ?>/<?php echo $plId; ?>/<?php echo $row['intId']; ?>" class="badge badge-primary" ><?php echo $row['totalProgram']; ?></a>
                                        <?php } else {
                                            echo $row['totalProgram'];
                                        } ?>
                                </td>  
                                 
                                <td> 
                                  
                                  <a href="<?php echo APP_URL; ?>addInstituteRegistration/<?php echo $glId; ?>/<?php echo $plId; ?>/<?php echo $row['intId']; ?>" class="btn btn-info">Tag Program</a>
