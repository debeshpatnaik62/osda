<?php
    ...
    $explPriv       = $objStudent->checkPrivilege($userId, $glId, $plId, $pageName, 'V');
...
/*
    ...
    if(isset($_REQUEST['hdn_qs'])&& $_REQUEST['hdn_qs']!='' )
    {
        ...
        $outMsg = $objStudent->deleteStudent($qs,$ids);
    }
        ...
        if($isPaging==0){
            ...
            $result     = $objStudent->manageStudent('PG', $arrConditions); 
    }
    ...
    else
    {
            ...
            $result                 = $objStudent->manageStudent('V',$arrConditions);
          //  print_r($result);exit;
    }
           $intPgSize                   = 10;

       $totalResult                 = $objStudent->manageStudent('V',$arrConditions);
