<?php
    /* ================================================
    File Name         	: archieveMsgdetailsInner.php
  ...
  //============ Search Function ========================//
        ...
        try{
           ...
           if($isPaging==0)	
               $result		= $objMsg->manageMsgboard('PG',$intRecno,$strName,'','','','','','',0,1,0,$intInst,'','');                        
           else
           {
               $intPgno	= 1;
               $intRecno	= 0;
               $result                 = $objMsg->manageMsgboard('V',0,$strName,'','','','','','',0,1,0,$intInst,'','');            
           }
          $totalResult                 = $objMsg->manageMsgboard('V',0,$strName,'','','','','','',0,1,0,$intInst,'','');        
