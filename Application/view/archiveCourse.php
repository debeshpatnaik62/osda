<?php
/* ================================================
  File Name         	  : archiveCourse.php
  Description		  : This is used for view the archieved course details.
  ...
  Style sheet           : 
  Javscript Functions   : 
  includes              : util.php,archiveCourseInner.php

  ================================================== */
require("archiveCourseInner.php");
?>

<script language="javascript">
    $(document).ready(function () {
        loadNavigation('Archive Course Details');
        pageHeader      = "Archive Course Details";
                  ...
                  <label class="col-sm-1 control-label no-padding-right" for="ddlSector">Sector</label>
                   ...
                   <label class="col-sm-2 control-label no-padding-right" for="txtCourseName"> Course Name</label>
                      ...
                      <div class="col-sm-2">
                        ...
                        <input class="btn btn-danger" name="btnClear" type="button" value="Clear" onclick="window.location.href = '<?php echo APP_URL; ?>archiveCourse/<?php echo $glId . '/' . $plId; ?>' ">
                     </div>                
              </div>
            </div>
                        ...
                        <?php while ($row = mysqli_fetch_array($result)) {
                            ...
                            <tr >
                                ...
                                <td> <?php  echo htmlspecialchars_decode($row['vchSecotrName'],ENT_QUOTES);?> </td>  
                                 <td> <?php  echo $row['intDuration'];?> </td>  
