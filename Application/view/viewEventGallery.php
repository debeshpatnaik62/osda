<?php
 ...
 ==================================================*/
    include_once('viewEventGalleryInner.php');
?>
...
<iframe width="200" height="200" src="<?php echo $row['vchImage'];?>" frameborder="0" allow="autoplay; encrypted-media" allowfullscreen></iframe>                                   
 <?php }else echo '&nbsp;';?>
                                ...
                                <td align="center" valign="middle" class="noPrint"><a href="<?php echo APP_URL?>addEventGallery/<?php echo $glId; ?>/<?php echo $plId; ?>/<?php echo $row['intEventGalId'] ?>" data-rel="tooltip" title="" data-original-title="Edit" class="btn btn-xs btn-info"> <i class="ace-icon fa fa-pencil bigger-120"></i> </a></td>
                            </tr>
                        <?php } ?>
                         </tbody>
                    </table>
