<?php
 /* ================================================
    File Name       : viewInstGalleryInner.php
    Description		: This page is used to  view Institute Gallery.
...
//======================= Permission ===========================*/
 ...
 //======================= Pagination ===========================*/
  ...
  //============= Delete/Active/Inactive function =================
        ...
        if($isPaging==0)	
            $result         = $objInstGal->manageInstGal('PG',$intRecno,$intDist,$intInst,'','','','','',0,0,0);
        else                                    
        {
            $intPgno        = 1;
            $intRecno       = 0;
            $result                 = $objInstGal->manageInstGal('V',0,$intDist,$intInst,'','','','','',0,0,0);
        }
       $totalResult                 = $objInstGal->manageInstGal('V',0,$intDist,$intInst,'','','','','',0,0,0);
