    ...
    if($isPaging==0 && $_REQUEST['hdn_PageNo']=='' && $_REQUEST['ID']>0)
    {
     ...
     try{
         //============= Delete/Active/Inactive function =================
            ...
            if($isPaging==0)    
                $result                 = $objVenueTag->manageVenueTagged('PPT',$intRecno,'',0,$id,0,0,'1000-01-01','00:00:00',0,'',$intLevel,$intPgSize);
            else                                    
            {
                $intPgno                = 1;
                $intRecno               = 0;
                $result                 = $objVenueTag->manageVenueTagged('VPT',0,'',0,$id,0,0,'1000-01-01','00:00:00',0,'',$intLevel,$intPgSize);
            }
            $totalResult                = $objVenueTag->manageVenueTagged('CPT',0,'',0,$id,0,0,'1000-01-01','00:00:00',0,'',$intLevel,$intPgSize);
