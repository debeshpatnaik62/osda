<?php
    ...
    ==================================================*/
    require 'viewEventNewsInner.php';
?>
...
<script language="javascript">
	$(document).ready(function () {
		loadNavigation('View Events News');
                 strFirstLink = "Manage Application";
                strLastLink = "Events News";
                                    ...
                                    <?php if($row['vchImageFile']!='')
                                     {
                                         ...
                                         {
                                    ?>
                                            <img src="<?php echo APP_URL ?>uploadDocuments/news/<?php echo $row['vchImageFile'];?>" alt="<?php echo $row['vchHeadLineE']; ?>" width="150" height="80" />
                                    <?php 
                                         }
                                        else {
                                       ?>
                                           <img src="<?php echo APP_URL ?>uploadDocuments/news/<?php echo $row['vchImageFile'];?>" alt="" width="100" height="100" border="0" align="absmiddle"/>
...
<!--                                <td align="center" width="70" >
                                ...
                                <td align="center" valign="middle" class="noPrint" style="<?php echo $editPriv; ?>"><a href="<?php echo APP_URL?>addEventNews/<?php echo $glId; ?>/<?php echo $plId; ?>/<?php echo $row['intNewsId'] ?>" data-rel="tooltip" title="" data-original-title="Edit" class="btn btn-xs btn-info"> <i class="ace-icon fa fa-pencil bigger-120"></i> </a></td>
                            </tr>
                        <?php } ?>
                         </tbody>
                    </table>
