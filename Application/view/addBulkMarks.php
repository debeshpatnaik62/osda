...
{ ?>
    ...
    <div style="text-align: right">
      <a class="btn btn-success" download href="<?php echo APP_URL ?>uploadDocuments/bulk/Marks_entry.xls">Download Excel xls Format</a>
    </div>
    <hr>
