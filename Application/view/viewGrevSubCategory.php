    ...
    <div class="row">
        <div class="col-xs-12">
            ...
            <div class="top_tab_container">
              ...
              <a href="<?php echo APP_URL ?>addGrevSubCategory/<?php echo $glId; ?>/<?php echo $plId; ?>" class="btn btn-info">Add</a> 
                        ...
                        <?php while ($row = $result->fetch_array()) {
                         ...
                         ?>
                            <tr>
                               ...
                               <td align="center" valign="middle" class="noPrint" style="<?php echo $editPriv; ?>"><a href="<?php echo APP_URL?>addGrevSubCategory/<?php echo $glId; ?>/<?php echo $plId; ?>/<?php echo $row['INT_CATEGORY_ID'] ?>" data-rel="tooltip" title="" data-original-title="Edit" class="btn btn-xs btn-info"> <i class="ace-icon fa fa-pencil bigger-120"></i> </a></td>
                            </tr>
                        <?php } ?>
                         </tbody>
                    </table>
