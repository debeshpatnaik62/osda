<?php
   ...
   $gender             = (isset($_POST['selGender']) && $_POST['selGender']!= '')?$_POST['selGender']:0;
     ...
     //============= Delete/Active/Inactive function =================
               ...
               if($isPaging==0)	
                   $result		= $objReport->manageReport('TPG', $intRecno, 0,'','','', '1000-01-01',0,0,0,'1000-01-01','1000-01-01');

               else
               {
                   $intPgno	= 1;
                   $intRecno	= 0;
                   $result                 = $objReport->manageReport('TP',$reportId, 0,'','','', '1000-01-01',0,0,0,'1000-01-01','1000-01-01'); 
               }
              $totalResult                 = $objReport->manageReport('TP',$reportId, 0,'','','', '1000-01-01',0,0,0,'1000-01-01','1000-01-01');
              $toalNumber = 0;
