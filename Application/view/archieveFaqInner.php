<?php
    /* ================================================
    File Name         	: archieveFaqInner.php
    Description		: This page is used to view archived Faqs.
    Author Name		: T Ketaki Debadarshini
    Date Created	: 1-Dec-2015
    Update History	:
	...
	if(isset($_REQUEST['hdn_qs'])&& $_REQUEST['hdn_qs']!='' )
	{
        ...
        if($isPaging==0)
            ...
            $result		= $objFaq->manageFaq('PG',$intRecno,$strHeadlineE,'','','',0,1,0);
		  
	else
	{
            $intPgno	= 1;
            $intRecno	= 0;
            $result                 = $objFaq->manageFaq('V',0,$strHeadlineE,'','','',0,1,0);
	}
       $totalResult                 = $objFaq->manageFaq('V',0,$strHeadlineE,'','','',0,1,0);
