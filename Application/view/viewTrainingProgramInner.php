<?php
  ...
  //print_r($_SESSION);exit;
    ...
    if($isPaging==0 && $_REQUEST['hdn_PageNo']=='' && $_REQUEST['ID']>0)
    {
     ...
     else
     {
        ...
        if($isPaging==0){
            ...
            $arrConditions=array('reportID'=>$intRecno ,'pageCount'=>20,'tpId'=>$insId,'userId'=>$userId);

            $result     = $objTP->manageskillTP('PGP', $arrConditions); 
    }
    ...
    else
    {
            ...
            $intRecno   = 0;
            $arrConditions=array('reportID'=>$intRecno ,'pageCount'=>20,'tpId'=>$insId,'userId'=>$userId);
            $result                 = $objTP->manageskillTP('VP',$arrConditions);
          //  print_r($result);exit;
    }
           $intPgSize                   = 20;

       $totalResult                 = $objTP->manageskillTP('VP',$arrConditions);
