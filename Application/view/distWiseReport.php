<?php
    /* ================================================
    File Name         	  : distWiseReport.php
    Description		      : This is used for view Skill Report.
    Author Name           : Rahul Kumar Saw
    Date Created          : 
    Devloped On           : 04-July-2022
    Devloped By           : Rahul Kumar Saw
    Update History	      : <Updated by>		<Updated On>		<Remarks>

    Style sheet           : 
    Javscript Functions   : 
    includes		  : util.php, distWiseReport.php

    ==================================================*/
    require 'distWiseReportInner.php';

?>
<script src="<?php echo APP_URL; ?>js/validatorchklist.js"></script>
<script language="javascript">
	$(document).ready(function () {
            loadNavigation('District Wise Report');
            pageHeader      = "District Wise Report";
            strFirstLink    = "Manage Reports";
            strLastLink     = "District Wise Report";
            downloadMe    = "yes";
    ...
    <div class="page-content">
        ...
        <div class="row">
            ...
            <div class="top_tab_container">
                <a href="javascript:void(0);" class="btn btn-info active">District Report <span class="badge badge-pill badge-danger"><strong><?php echo $toalNumber;?></strong></span></a>
            </div>
              		...
              		<tbody>
                        <?php while ($row = mysqli_fetch_array($result)) {
                            ...
                            <tr>
                               ...
                               <!--  <td><?php echo $row['totalCandidate']; ?></td> -->
                               <td>
                                <?php if ($row['totalCandidate'] > 0) { ?>
                                            <a href="<?php echo APP_URL; ?>viewCandidateDetails/<?php echo $row['intDistrictId']; ?>/<?php echo $regdType; ?>/<?php echo $gender; ?>" class="badge badge-primary" ><?php echo $row['totalCandidate']; ?></a>
                                        <?php } else {
                                            echo $row['totalCandidate'];
                                        } ?>
                                </td>

                               <!--  <td> <?php  echo $row['maleCandidate'];?> </td>  
                                <td> <?php  echo $row['femaleCandidate'];?> </td>  
                                <td> <?php  echo $row['otherCandidate'];?> </td>   -->
                            </tr>
                        <?php } ?>
                        <th></th>
                        <th>Total</th>
                            <td>
                                <strong><?php echo $toalNumber;?></strong>
                            </td>
                        </tbody>
                    </table>
