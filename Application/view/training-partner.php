<?php
    ...
    require 'training-partnerInner.php';
?>

<script src="<?php echo APP_URL; ?>js/validatorchklist.js"></script>
<script language="javascript">
	$(document).ready(function () {
		pageHeader = "View Training Partner";
                strFirstLink = "Manage Application";
                strLastLink = "Training Partner";
               loadNavigation('View Training Partner');
    ...
    <div class="page-content">
        ...
        <div class="row">
            ...
            <div class="top_tab_container">
               <!-- <?php  if ($noAdd != '1') { ?>
                    <a href="<?php echo APP_URL?>addtraining-partner/<?php echo $glId; ?>/<?php echo $plId; ?>" class="btn btn-info">Add</a>
                <?php }?> -->
                ...
                <a href="javascript:void(0);" class="btn btn-info active">View Training Partner</a>
                 </div>
                ...
                <div class="searchTable">
                    <div class="form-group">
                        ...
                        <div class="col-sm-2">
                            ...
                            <input class="btn btn-danger" name="btnClear" type="button" value="Clear" onclick="window.location.href ='<?php echo APP_URL; ?>training-partner/<?php echo $glId . '/' . $plId; ?>' ">
                        </div>
                    </div>
                </div>
                <div class="legandBox">			
                    <span class="greenLegend">&nbsp;</span>Published training-partner(s)&nbsp;			
                    <span class="yellowLegend">&nbsp;</span> Unpublished training-partner(s) &nbsp;
                </div>
                <div id="viewTable">
              		...
              		<tbody>
                        <?php while ($row = mysqli_fetch_array($result)) {
                            ...
                            <tr <?php echo $style;?>>
                               ...
                               <td> <?php  echo htmlspecialchars_decode($row['vchInstitute'],ENT_NOQUOTES);?> </td>
                                ...
                                <td>
                                    ...
                                    <?php if ($row['vchMessage'] != '') { ?>
                                            ...
                                            <?php $strMessage =  htmlspecialchars_decode($row['vchMessage'], ENT_QUOTES); 
                                              echo $shortmsg = $objTraining->wardWrap($strMessage, 100);
                                            ?></a>
    ...
    <?php echo $objTraining->getPageNumbers($intTotalRec, $intCurrPage, $intPgSize, $isPaging); ?>
                        </div>
                    </div>
    <?php if ($isPaging == 0 && $intTotalRec > $intPgSize) { ?>
                        <div class="col-xs-6">
                            <div class="dataTables_paginate paging_bootstrap">
                                <ul class="pagination">
        <?php echo $objTraining->getPaging($intTotalRec, $intCurrPage, $intPgSize, $isPaging); ?>                    
                                </ul>
                            </div>
                        </div>
                <?php } ?>
