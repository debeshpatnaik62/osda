<?php
    /* ================================================
    File Name         	  : viewEngineeringReport.php
    ...
    ==================================================*/
    require 'viewEngineeringReportInner.php';
?>
<script src="<?php echo APP_URL; ?>js/validatorchklist.js"></script>
<script language="javascript">
	$(document).ready(function () {
            loadNavigation('Engineering College Report');
            pageHeader      = "Engineering College Report";
            strFirstLink    = "Manage Reports";
            strLastLink     = "Engineering College Report";
            downloadMe    = "yes";
    ...
    <div class="page-content">
        ...
        <div class="row">
            ...
            <div class="top_tab_container">
                ...
                <a href="javascript:void(0);" class="btn btn-info active">Engineering Colleges <span class="badge badge-danger"><?php echo $engCount;?></span></a> 
            ...
            <div class="searchTable">
              <div class="form-group">
                ...
                <?php if (mysqli_num_rows($result) > 0) {
                    ...
                    <input name="hdn_qualification" id="hdn_qualify" type="hidden" value="15"/>
                <?php } else { ?>
