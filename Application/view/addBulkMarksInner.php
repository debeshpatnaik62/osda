...
set_time_limit(0);
	...
	$strclick 			= ($id > 0) ? "window.location.href='" . APP_URL."addBulkMarks/".$glId."/".$plId. "';":"$('#userImage').hide();";
	$flag 				= 0;
	$errFlag 			= 0;
	$outMsg 			= '';
	$redirectLoc		= '';
...
//============ Button Submit ===================
	...
	{
           $result          		= $objBulk->insertMarksData();
           $outMsg          		=  $result['msg']; 
           $flag            		=  $result['flag'];
           $redirectLoc         =  APP_URL."addBulkMarks/".$glId."/".$plId;
	}
