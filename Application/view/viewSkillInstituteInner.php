<?php
	...
	/*if(isset($_REQUEST['hdn_qs'])&& $_REQUEST['hdn_qs']!='' )
	{
        ...
        if($isPaging==0)	
            $result		= $objInstitute->manageSkillMaster('PGI',$intRecno,0,'','','',$userId);		  
	else                                    
	{
            $intPgno	= 1;
            $intRecno	= 0;
            $result                 = $objInstitute->manageSkillMaster('VI',0,0,'','','',$userId);
	}
       $totalResult                 = $objInstitute->manageSkillMaster('VI',0,0,'','','',$userId);
