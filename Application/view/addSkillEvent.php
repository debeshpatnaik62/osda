...
/* ================================================
  ...
  ================================================== */
    ...
    require 'addSkillEventInner.php';
?>
...
<script language="javascript">
    $(document).ready(function () {
        ...
        strLastLink = "Skill Event";
        loadNavigation('<?php echo $strTab; ?> Skill Events');
        indicate = 'yes';
        $('#txtHeadlineE').focus();
    ...
    function validator()
    {
        ...
        /* if (!compareCurDate('txtStartDate', 'News Date', 'g'))
                    return false;*/
        /*if (!blankCheck('fileDocument', 'Event Photo can not left blank'))
            return false;*/
        if ($('#fileDocument').val() != '')
        {
            if (!IsCheckFile('fileDocument', 'Invalid file types. Upload only ', 'jpg,jpeg'))
                return false;
       ...
       if (!blankCheck('txtStartDate', 'Event Start Date can not left blank'))
            return false;
       if (!blankCheck('txtEndDate', 'Event End Date can not left blank'))
            return false;

       
        /*var newsDrelats   = CKEDITOR.instances['txtDetailsE'].getData();
        if(newsDrelats == ''){
                viewAlert('Events details can not left blank');
                return false;
            } */               
    }
  ...
  <div class="row">
    <div class="col-xs-12"> 
      ...
      <div class="top_tab_container"> <a href="javascript:void(0);" class="btn btn-info active"><?php echo $strTab;?></a> 
          <a href="<?php echo APP_URL; ?>viewSkillEvent/<?php echo $glId; ?>/<?php echo $plId; ?>" class="btn btn-info">View</a></div>
      ...
      <div class="hr hr-solid"></div>
        ...
        <div class="col-xs-12">
          ...
          <div class="form-group">
            <label class="col-sm-2 control-label no-padding-right" for="fileDocument">Event Photo</label>
            <div class="col-sm-4"> <span class="colon">:</span>
        ...
        <?php if (($id > 0) && ($strFileName!='')) { 
              ...
              <img id="userImage" width="80" height="70" alt="" class="mgnLft_10 mgnTop_10" src="<?php echo APP_URL . 'uploadDocuments/event/' . $strFileName; ?>">
              
              <?php 
                                }else {
                              ?>
              <a href="<?php echo APP_URL;?>uploadDocuments/event/<?php echo $row['vchImageFile'];?>" target="_blank" id="userImage">
              <?php if($fileExt=='pdf'){?>
          ...
          <div class="form-group">
            ...
            <div class="col-sm-8"> <span class="red">(jpg,jpeg file only and Max file Size 1 MB.)</span> </div>
          </div>
          
          <div class="form-group">
            <label class="col-sm-2 control-label no-padding-right" for="txtStartDate">Event Start Date</label>
            <div class="col-sm-4"> <span class="colon">:</span>
              <div class="input-group">
                  <input type="text" data-date-format="dd-mm-yyyy" name="txtStartDate" id="txtStartDate" readonly="true" class="form-control date-picker" value="<?php echo $strStratDate; ?>">
                <span class="input-group-addon"> <i class="fa fa-calendar bigger-110"></i> </span> </div>
              <span class="mandatory">*</span> </div>
          </div>

          <div class="form-group">
            <label class="col-sm-2 control-label no-padding-right" for="txtEndDate">Event End Date</label>
            <div class="col-sm-4"> <span class="colon">:</span>
              <div class="input-group">
                  <input type="text" data-date-format="dd-mm-yyyy" name="txtEndDate" id="txtEndDate" readonly="true" class="form-control date-picker" value="<?php echo $strEndDate; ?>">
                <span class="input-group-addon"> <i class="fa fa-calendar bigger-110"></i> </span> </div>
              <span class="mandatory">*</span> </div>
          </div>
