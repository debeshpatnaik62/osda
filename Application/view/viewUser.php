                    ...
                    <div class="form-group">
                       ...
                       <label class="col-sm-1 control-label no-padding-right" for="ddlDepartment">Department</label>
                        ...
                        <div class="col-sm-2">
                            ...
                            <input class="btn btn-danger" name="btnClear" type="button" value="Clear" onclick="window.location.href ='<?php echo APP_URL; ?>viewUser/<?php echo $glId . '/' . $plId; ?>' ">
                        </div>
                    </div>
                </div>
                    ...
                    while ($row = mysqli_fetch_array($result)) 
                     {
                        ...
                        if($row['INT_PUBLISH_STATUS']==1)
                           ...
                           <td><?php echo $intCount;?></td>
                            ...
                            <td align="center" valign="middle" class="noPrint" style="<?php echo $editPriv;?>"><a href="<?php echo APP_URL;?>addUser/<?php echo $glId;?>/<?php echo $plId;?>/<?php echo $row['INT_ID'];?>" title="Edit" class="btn btn-xs btn-info"><i class="ace-icon fa fa-pencil bigger-120"></i></a></td>
                          </tr>
