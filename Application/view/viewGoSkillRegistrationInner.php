<?php
    ...
    if($isPaging==0 && $_REQUEST['hdn_PageNo']=='' && $_REQUEST['ID']>0)
    {
        ...
        $strNumber            = (isset($_REQUEST['txtMobile']) && $_REQUEST['txtMobile']!= '')?$_REQUEST['txtMobile']:'';
    ...
    /*if(isset($_REQUEST['hdn_qs'])&& $_REQUEST['hdn_qs']!='' )
    {
        ...
        if($isPaging==0){
            ...
            $arrConditions=array('reportID'=>$intRecno , 'startDate'=> $strStartDt , 'endDate'=> $strEndDate ,'pubStatus'=>0, 'pageCount'=>20,'strName' =>$strName,'strNumber' =>$strNumber);

            $result     = $objDevelop->manageskillInformation('PG', $arrConditions); 
    }
    ...
    else
    {
            ...
            $intRecno   = 0;
            $arrConditions=array('reportID'=>$intRecno , 'startDate'=> $strStartDt , 'endDate'=> $strEndDate ,'pubStatus'=>0, 'pageCount'=>20,'strName' =>$strName,'strNumber' =>$strNumber);
            $result                 = $objDevelop->manageskillInformation('V',$arrConditions);
          //  print_r($result);exit;
    }
           $intPgSize                   = 20;

       $totalResult                 = $objDevelop->manageskillInformation('V',$arrConditions);
