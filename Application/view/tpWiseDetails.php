<?php
    /* ================================================
    File Name         	  : tpWiseDetails.php
    Description		      : This is used for view TP wise candidate Report.
    Author Name           : Rahul Kumar Saw
    Date Created          : 
    Devloped On           : 06-July-2022
    Devloped By           : Rahul Kumar Saw
    Update History	      : <Updated by>		<Updated On>		<Remarks>

    Style sheet           : 
    Javscript Functions   : 
    includes		  : util.php, tpWiseDetails.php

    ==================================================*/
    require 'tpWiseDetailsInner.php';

?>
<script src="<?php echo APP_URL; ?>js/validatorchklist.js"></script>
<script language="javascript">
	$(document).ready(function () {
            loadNavigation('Training Partner Wise Report');
            pageHeader      = "Training Partner Report";
            strFirstLink    = "Manage Reports";
            strLastLink     = "Training Partner Report";
            downloadMe    = "yes";
    ...
    <div class="page-content">
        ...
        <div class="row">
            ...
            <div class="top_tab_container">
                <a href="javascript:void(0);" class="btn btn-info active">TP Wise Report <span class="badge badge-pill badge-danger"><strong><?php echo $toalNumber;?></strong></span></a>
            </div>
                            ...
                            <tr>
                               ...
                               <td><?php echo $ctr; ?></td>
                                ...
                                <?php if ($row['totalCandidate'] > 0) { ?>
                                            <a href="<?php echo APP_URL; ?>viewSkillRegistration/<?php echo $glId; ?>/<?php echo $plId; ?>/<?php echo $row['intId']; ?>" class="badge badge-primary" ><?php echo $row['totalCandidate']; ?></a>
                                        <?php } else {
