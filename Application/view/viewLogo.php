                    ...
                    <table class="table  table-bordered table-hover">
                        <thead>
                            <tr>
                                ...
                                <th>Title in Odia</th>
                                <th>Admin logo</th> 
                                 <th>Default Web Logo</th>
                                 <th>Black Theme Web Logo</th>
         ...
         <?php while ($row = mysqli_fetch_array($result)) {
              		...
              		<tbody>
                          <tr>
                                ...
                                <td class="odia"> 
                                    <?php  echo htmlspecialchars_decode($row['VCH_LOGO_TITLE_O'],ENT_NOQUOTES);?>
                                </td> 
                                <td align="center" width="100">
                                   <img src="<?php echo APP_URL; ?>uploadDocuments/Logo/<?php echo $row['VCH_IMAGE']; ?>" alt="<?php echo $row['VCH_LOGO_TITLE']; ?>" width="200" height="80" border="0" align="absmiddle" >
                                </td>
                                <td align="center" width="100">
                                    <img src="<?php echo APP_URL; ?>uploadDocuments/Logo/<?php echo $row['VCH_IMAGE_H']; ?>" alt="<?php echo $row['VCH_LOGO_TITLE']; ?>" width="200" height="80" border="0" align="absmiddle" >
                                 </td>
                                  <td align="center" width="100">
                                    <img src="<?php echo APP_URL; ?>uploadDocuments/Logo/<?php echo $row['VCH_IMAGE_O']; ?>" alt="<?php echo $row['VCH_LOGO_TITLE']; ?>" width="200" height="80" border="0" align="absmiddle" >
                                 </td>
                                 
                                
<!--                                <td align="center" valign="middle" class="noPrint"><a href="<?php echo APP_URL?>addLogo/<?php echo $row['INT_LOGO_ID'] ?>" data-rel="tooltip" title="" data-original-title="Edit" class="btn btn-xs btn-info"> <i class="ace-icon fa fa-pencil bigger-120"></i> </a></td>-->
                            </tr>
                    <?php } ?>    
                         </tbody>
                    </table>
