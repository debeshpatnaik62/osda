 ...
 //======================= Pagination ===========================*/
  ...
  //============= Delete/Active/Inactive function =================
        ...
        if($isPaging==0)	
            ...
            $result         = $objInstGal->manageEventGal('PG',$intRecno,0,$strCaption,$strCaption,'','','',0,1,0);
        else                                    
        {
            $intPgno        = 1;
            $intRecno       = 0;
            $result                 = $objInstGal->manageEventGal('V',0,0,$strCaption,$strCaption,'','','',0,1,0);
        }
       $totalResult                 = $objInstGal->manageEventGal('V',0,0,$strCaption,$strCaption,'','','',0,1,0);
