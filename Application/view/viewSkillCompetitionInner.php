...
//============ Permission =====================//
     ...
     $explPriv   = $objCompete->checkPrivilege($userId, $glId, $plId, $pageName, 'VB');
...
//=================== View skill records ================================
        if ($isPaging==0) {
            $result		= $objCompete->manageSkillCompetition('PGB',$intRecno,$intDistrict,$intBlock,'','','','',0,'0000-00-00','','','','','','',0,'','','',0,'',0,'',0,'',$strName,$intPgSize,0,$intSkill,$strStartDt,$strEndDate);
        } else {
            $intPgno            = 1;
            $intRecno           = 0;
            $result		= $objCompete->manageSkillCompetition('VB',0,$intDistrict,$intBlock,'','','','',0,'0000-00-00','','','','','','',0,'','','',0,'',0,'',0,'',$strName,0,0,$intSkill,$strStartDt,$strEndDate);
        }

        $totalResult            = $objCompete->manageSkillCompetition('CTB',0,$intDistrict,$intBlock,'','','','',0,'0000-00-00','','','','','','',0,'','','',0,'',0,'',0,'',$strName,0,0,$intSkill,$strStartDt,$strEndDate);
