<script type="text/javascript" src="<?php echo APP_URL?>js/jquery.min.js"></script>
<link rel="stylesheet" type="text/css" href="<?php echo APP_URL?>css/custom.css">
<div class="viewTable" id="viewTable">
<table class="viewTable">
<tr><th>Sl#</th><th>Document/Image name</th><th>Image</th></tr>
<?php	
	...
	foreach(glob($log_directory.'/*.*') as $file) 
	{
		...
		if($ext=='JPG' || $ext=='jpg' || $ext=='jpeg' || $ext=='gif' || $ext=='png' || $ext=='bmp')
		{
?>
...
<?php
         ...
         ?>
                <tr><td width="25"><?php echo $ctr;?></td><td><a href="javascript:setLink('<?php echo $folderPath.basename($file);?>');" ><?php echo basename($file);?></a></td></tr>
