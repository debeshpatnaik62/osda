...
<div style="float:right; margin:8px 0px 0px 4px; width:190px; position:relative; text-align:right;" class="mandatory" id="indicate">
	...
	<a href="javascript:void(0);" title="Download" id="excelIcon" data-toggle="tooltip" data-placement="top" onclick="downloadExcel('EX');" class="btn btn-success btn-sm" ><i class="fa fa-file"></i></a>
    ...
    <a href="javascript:void(0)" title="Generate Image" id="refreshIcon" data-toggle="tooltip" data-placement="top" class="btn btn-success btn-sm" onclick="generate('GN');"><i class="icon-white icon-refresh"></i></a>
    ...
    <a href="javascript:void(0)" title="Make Confirm" id="confirmIcon" data-toggle="tooltip" data-placement="top" class="btn btn-purple btn-sm" onclick="gotoDelete('MC');"><i class="icon-white icon-ok"></i></a>
    <a href="javascript:void(0)" title="Make Unsubscribe" id="UnsubscribeIcon" data-toggle="tooltip" data-placement="top" class="btn btn-danger btn-sm" onclick="gotoDelete('MU');"><i class="icon-white icon-remove"></i></a>
</div>    
...
if(confirmMe=="yes")
 ...
 if(UnsubscribeMe=="yes")
	{
		$('#UnsubscribeIcon').show();
		$("#UnsubscribeIcon").tooltip();
	}
